...
public class SearchTableBean implements Serializable {
	...
	private String organizePoints; // 节点
	...
	public String getOrganizePoints() {
		return organizePoints;
	}

	public void setOrganizePoints(String organizePoints) {
		this.organizePoints = organizePoints;
	}
