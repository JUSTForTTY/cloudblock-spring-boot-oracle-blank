...
*/
@RestController
@RequestMapping("/cysysbaseuserprojectview")
public class CySysBaseUserProjectViewController {
	private final Log logger = LogFactory.getLog(getClass());
	
    @Resource
    private CySysBaseUserProjectViewBiz cySysBaseUserProjectViewBiz;
    ...
    @RequestBody CySysBaseUserProjectView cySysBaseUserProjectView) {
        ...
        cySysBaseUserProjectViewBiz.insertDataSettings(baseUserList.get(0),cySysBaseUserProjectView);
    ...
    @PathVariable String ids) {
        ...
        cySysBaseUserProjectViewBiz.deleteDataSettings(ids);
        if(tokenRefreshFlag) {
        	param.put("access_token", token);
        	param.put("refresh_token", refreshtoken);
    ...
    @RequestBody CySysBaseUserProjectView cySysBaseUserProjectView) {
        ...
        cySysBaseUserProjectViewBiz.updateDataSettings(baseUserList.get(0),cySysBaseUserProjectView);
        if(tokenRefreshFlag) {
        	param.put("access_token", token);
        	param.put("refresh_token", refreshtoken);
    ...
    @PathVariable String id) {
        ...
        CySysBaseUserProjectView cySysBaseUserProjectView = cySysBaseUserProjectViewBiz.getDataSettings(id);
        if(tokenRefreshFlag) {
        	param.put("access_token", token);
        	param.put("refresh_token", refreshtoken);
        	 
		}
        return ResultGenerator.genSuccessResult(cySysBaseUserProjectView,param);
    ...
    @RequestBody CySysBaseUserProjectView cySysBaseUserProjectView) {
        ...
        List<CySysBaseUserProjectView> cySysBaseUserProjectViewlst = cySysBaseUserProjectViewBiz.getDataSettingsByCondition(cySysBaseUserProjectView);
        if(tokenRefreshFlag) {
        	param.put("access_token", token);
        	param.put("refresh_token", refreshtoken);
        	 
		}
        return ResultGenerator.genSuccessResult(cySysBaseUserProjectViewlst,param);
    ...
    @RequestParam(defaultValue = "0") Integer page, @RequestParam(defaultValue = "0") Integer size) {
        ...
        try{
         PageInfo pageInfo=cySysBaseUserProjectViewBiz.getPageDataSettings(page,size);
        if(tokenRefreshFlag) {
        	param.put("access_token", token);
        	param.put("refresh_token", refreshtoken);
    ...
    @RequestParam(defaultValue = "0") Integer page, @RequestParam(defaultValue = "0") Integer size,@RequestBody CySysBaseUserProjectView cySysBaseUserProjectView) {
        ...
        try{
         PageInfo pageInfo=cySysBaseUserProjectViewBiz.getPageDataSettingsByCondition(page,size,baseUserList.get(0),cySysBaseUserProjectView);
        if(tokenRefreshFlag) {
        	param.put("access_token", token);
        	param.put("refresh_token", refreshtoken);
