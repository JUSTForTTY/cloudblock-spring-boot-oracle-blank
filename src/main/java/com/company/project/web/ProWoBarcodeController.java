...
*/
@RestController
@RequestMapping("/prowobarcode")
public class ProWoBarcodeController {
	private final Log logger = LogFactory.getLog(getClass());
	
    @Resource
    private ProWoBarcodeBiz proWoBarcodeBiz;
    ...
    @RequestBody ProWoBarcode proWoBarcode) {
        ...
        String insertId=proWoBarcodeBiz.insertDataSettings(baseUserList.get(0),proWoBarcode);
    ...
    @PathVariable String ids) {
        ...
        proWoBarcodeBiz.deleteDataSettings(ids);
        if(tokenRefreshFlag) {
        	param.put("access_token", token);
        	param.put("refresh_token", refreshtoken);
    ...
    @RequestBody ProWoBarcode proWoBarcode) {
        ...
        proWoBarcodeBiz.updateDataSettings(baseUserList.get(0),proWoBarcode);
        if(tokenRefreshFlag) {
        	param.put("access_token", token);
        	param.put("refresh_token", refreshtoken);
    ...
    @PathVariable String id) {
        ...
        ProWoBarcode proWoBarcode = proWoBarcodeBiz.getDataSettings(id);
        if(tokenRefreshFlag) {
        	param.put("access_token", token);
        	param.put("refresh_token", refreshtoken);
        	 
		}
        return ResultGenerator.genSuccessResult(proWoBarcode,param);
    ...
    @RequestBody ProWoBarcode proWoBarcode) {
        ...
        List<ProWoBarcode> proWoBarcodelst = proWoBarcodeBiz.getDataSettingsByCondition(proWoBarcode);
        if(tokenRefreshFlag) {
        	param.put("access_token", token);
        	param.put("refresh_token", refreshtoken);
        	 
		}
        return ResultGenerator.genSuccessResult(proWoBarcodelst,param);
    ...
    @RequestParam(defaultValue = "0") Integer page, @RequestParam(defaultValue = "0") Integer size) {
        ...
        try{
         PageInfo pageInfo=proWoBarcodeBiz.getPageDataSettings(page,size);
        if(tokenRefreshFlag) {
        	param.put("access_token", token);
        	param.put("refresh_token", refreshtoken);
    ...
    @RequestParam(defaultValue = "0") Integer page, @RequestParam(defaultValue = "0") Integer size,@RequestBody ProWoBarcode proWoBarcode) {
        ...
        try{
         PageInfo pageInfo=proWoBarcodeBiz.getPageDataSettingsByCondition(page,size,baseUserList.get(0),proWoBarcode);
        if(tokenRefreshFlag) {
        	param.put("access_token", token);
        	param.put("refresh_token", refreshtoken);
