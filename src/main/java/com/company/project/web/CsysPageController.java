...
/**
* Created by tty on 2019/04/23.
*/
@RestController
@RequestMapping("/csyspage")
public class CsysPageController {
    ...
    @RequestBody CsysPage csysPage) {
        ...
        String insertId=csysPageBiz.insertDataSettings(baseUserList.get(0),csysPage);
    ...
    @PathVariable String ids) {
        ...
        csysPageBiz.deleteDataSettings(ids);
        if(tokenRefreshFlag) {
        	param.put("access_token", token);
        	param.put("refresh_token", refreshtoken);
    ...
    @RequestBody CsysPage csysPage) {
        ...
        csysPageBiz.updateDataSettings(baseUserList.get(0),csysPage);
        if(tokenRefreshFlag) {
        	param.put("access_token", token);
        	param.put("refresh_token", refreshtoken);
    ...
    @PathVariable String id) {
        ...
        return ResultGenerator.genSuccessResult(csysPage,param);
    ...
    @RequestBody CsysPage csysPage) {
        ...
        List<CsysPage> csysPagelst = csysPageBiz.getDataSettingsByCondition(csysPage);
        if(tokenRefreshFlag) {
        	param.put("access_token", token);
        	param.put("refresh_token", refreshtoken);
        	 
		}
        return ResultGenerator.genSuccessResult(csysPagelst,param);
    ...
    @RequestParam(defaultValue = "0") Integer page, @RequestParam(defaultValue = "0") Integer size) {
        ...
        try{
         PageInfo pageInfo=csysPageBiz.getPageDataSettings(page,size);
        if(tokenRefreshFlag) {
        	param.put("access_token", token);
        	param.put("refresh_token", refreshtoken);
    ...
    @RequestParam(defaultValue = "0") Integer page, @RequestParam(defaultValue = "0") Integer size,@RequestBody CsysPage csysPage) {
        ...
        try{
         PageInfo pageInfo=csysPageBiz.getPageDataSettingsByCondition(page,size,baseUserList.get(0),csysPage);
        if(tokenRefreshFlag) {
        	param.put("access_token", token);
        	param.put("refresh_token", refreshtoken);
