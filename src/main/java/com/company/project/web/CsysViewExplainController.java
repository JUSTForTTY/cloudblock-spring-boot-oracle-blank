...
*/
@RestController
@RequestMapping("/csysviewexplain")
public class CsysViewExplainController {
    ...
    @RequestBody CsysViewExplain csysViewExplain) {
        ...
        String insertId=csysViewExplainBiz.insertDataSettings(baseUserList.get(0),csysViewExplain);
    ...
    @PathVariable String ids) {
        ...
        csysViewExplainBiz.deleteDataSettings(ids);
        if(tokenRefreshFlag) {
        	param.put("access_token", token);
        	param.put("refresh_token", refreshtoken);
    ...
    @RequestBody CsysViewExplain csysViewExplain) {
        ...
        csysViewExplainBiz.updateDataSettings(baseUserList.get(0),csysViewExplain);
        if(tokenRefreshFlag) {
        	param.put("access_token", token);
        	param.put("refresh_token", refreshtoken);
    ...
    @PathVariable String id) {
        ...
        CsysViewExplain csysViewExplain = csysViewExplainBiz.getDataSettings(id);
        if(tokenRefreshFlag) {
        	param.put("access_token", token);
        	param.put("refresh_token", refreshtoken);
        	 
		}
        return ResultGenerator.genSuccessResult(csysViewExplain,param);
    ...
    @RequestBody CsysViewExplain csysViewExplain) {
        ...
        List<CsysViewExplain> csysViewExplainlst = csysViewExplainBiz.getDataSettingsByCondition(csysViewExplain);
        if(tokenRefreshFlag) {
        	param.put("access_token", token);
        	param.put("refresh_token", refreshtoken);
        	 
		}
        return ResultGenerator.genSuccessResult(csysViewExplainlst,param);
    ...
    @RequestParam(defaultValue = "0") Integer page, @RequestParam(defaultValue = "0") Integer size) {
        ...
        try{
         PageInfo pageInfo=csysViewExplainBiz.getPageDataSettings(page,size);
        if(tokenRefreshFlag) {
        	param.put("access_token", token);
        	param.put("refresh_token", refreshtoken);
    ...
    @RequestParam(defaultValue = "0") Integer page, @RequestParam(defaultValue = "0") Integer size,@RequestBody CsysViewExplain csysViewExplain) {
        ...
        try{
         PageInfo pageInfo=csysViewExplainBiz.getPageDataSettingsByCondition(page,size,baseUserList.get(0),csysViewExplain);
        if(tokenRefreshFlag) {
        	param.put("access_token", token);
        	param.put("refresh_token", refreshtoken);
