...
*/
@RestController
@RequestMapping("/csysmenupageview")
public class CsysMenuPageViewController {
    ...
    @RequestBody CsysMenuPageView csysMenuPageView) {
        ...
        String insertId=csysMenuPageViewBiz.insertDataSettings(baseUserList.get(0),csysMenuPageView);
    ...
    @PathVariable String ids) {
        ...
        csysMenuPageViewBiz.deleteDataSettings(ids);
        if(tokenRefreshFlag) {
        	param.put("access_token", token);
        	param.put("refresh_token", refreshtoken);
    ...
    @RequestBody CsysMenuPageView csysMenuPageView) {
        ...
        csysMenuPageViewBiz.updateDataSettings(baseUserList.get(0),csysMenuPageView);
        if(tokenRefreshFlag) {
        	param.put("access_token", token);
        	param.put("refresh_token", refreshtoken);
    ...
    @PathVariable String id) {
        ...
        CsysMenuPageView csysMenuPageView = csysMenuPageViewBiz.getDataSettings(id);
        if(tokenRefreshFlag) {
        	param.put("access_token", token);
        	param.put("refresh_token", refreshtoken);
        	 
		}
        return ResultGenerator.genSuccessResult(csysMenuPageView,param);
    ...
    @RequestBody CsysMenuPageView csysMenuPageView) {
        ...
        List<CsysMenuPageView> csysMenuPageViewlst = csysMenuPageViewBiz.getDataSettingsByCondition(csysMenuPageView);
        if(tokenRefreshFlag) {
        	param.put("access_token", token);
        	param.put("refresh_token", refreshtoken);
        	 
		}
        return ResultGenerator.genSuccessResult(csysMenuPageViewlst,param);
    ...
    @RequestParam(defaultValue = "0") Integer page, @RequestParam(defaultValue = "0") Integer size) {
        ...
        try{
         PageInfo pageInfo=csysMenuPageViewBiz.getPageDataSettings(page,size);
        if(tokenRefreshFlag) {
        	param.put("access_token", token);
        	param.put("refresh_token", refreshtoken);
    ...
    @RequestParam(defaultValue = "0") Integer page, @RequestParam(defaultValue = "0") Integer size,@RequestBody CsysMenuPageView csysMenuPageView) {
        ...
        try{
         PageInfo pageInfo=csysMenuPageViewBiz.getPageDataSettingsByCondition(page,size,baseUserList.get(0),csysMenuPageView);
        if(tokenRefreshFlag) {
        	param.put("access_token", token);
        	param.put("refresh_token", refreshtoken);
