...
*/
@RestController
@RequestMapping("/cysysblocksucu04weight0020003")
public class CySysBlockSucu04weight0020003Controller {
	private final Log logger = LogFactory.getLog(getClass());
	
    @Resource
    private CySysBlockSucu04weight0020003Biz cySysBlockSucu04weight0020003Biz;
    ...
    @RequestBody CySysBlockSucu04weight0020003 cySysBlockSucu04weight0020003) {
        ...
        String insertId=cySysBlockSucu04weight0020003Biz.insertDataSettings(baseUserList.get(0),cySysBlockSucu04weight0020003);
    ...
    @PathVariable String ids) {
        ...
        cySysBlockSucu04weight0020003Biz.deleteDataSettings(ids);
        if(tokenRefreshFlag) {
        	param.put("access_token", token);
        	param.put("refresh_token", refreshtoken);
    ...
    @RequestBody CySysBlockSucu04weight0020003 cySysBlockSucu04weight0020003) {
        ...
        cySysBlockSucu04weight0020003Biz.updateDataSettings(baseUserList.get(0),cySysBlockSucu04weight0020003);
        if(tokenRefreshFlag) {
        	param.put("access_token", token);
        	param.put("refresh_token", refreshtoken);
    ...
    @PathVariable String id) {
        ...
        CySysBlockSucu04weight0020003 cySysBlockSucu04weight0020003 = cySysBlockSucu04weight0020003Biz.getDataSettings(id);
        if(tokenRefreshFlag) {
        	param.put("access_token", token);
        	param.put("refresh_token", refreshtoken);
        	 
		}
        return ResultGenerator.genSuccessResult(cySysBlockSucu04weight0020003,param);
    ...
    @RequestBody CySysBlockSucu04weight0020003 cySysBlockSucu04weight0020003) {
        ...
        List<CySysBlockSucu04weight0020003> cySysBlockSucu04weight0020003lst = cySysBlockSucu04weight0020003Biz.getDataSettingsByCondition(cySysBlockSucu04weight0020003);
        if(tokenRefreshFlag) {
        	param.put("access_token", token);
        	param.put("refresh_token", refreshtoken);
        	 
		}
        return ResultGenerator.genSuccessResult(cySysBlockSucu04weight0020003lst,param);
    ...
    @RequestParam(defaultValue = "0") Integer page, @RequestParam(defaultValue = "0") Integer size) {
        ...
        try{
         PageInfo pageInfo=cySysBlockSucu04weight0020003Biz.getPageDataSettings(page,size);
        if(tokenRefreshFlag) {
        	param.put("access_token", token);
        	param.put("refresh_token", refreshtoken);
    ...
    @RequestParam(defaultValue = "0") Integer page, @RequestParam(defaultValue = "0") Integer size,@RequestBody CySysBlockSucu04weight0020003 cySysBlockSucu04weight0020003) {
        ...
        try{
         PageInfo pageInfo=cySysBlockSucu04weight0020003Biz.getPageDataSettingsByCondition(page,size,baseUserList.get(0),cySysBlockSucu04weight0020003);
        if(tokenRefreshFlag) {
        	param.put("access_token", token);
        	param.put("refresh_token", refreshtoken);
