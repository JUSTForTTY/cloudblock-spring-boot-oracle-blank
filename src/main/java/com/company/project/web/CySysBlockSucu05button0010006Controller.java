...
*/
@RestController
@RequestMapping("/cysysblocksucu05button0010006")
public class CySysBlockSucu05button0010006Controller {
	private final Log logger = LogFactory.getLog(getClass());
	
    @Resource
    private CySysBlockSucu05button0010006Biz cySysBlockSucu05button0010006Biz;
    ...
    @RequestBody CySysBlockSucu05button0010006 cySysBlockSucu05button0010006) {
        ...
        String insertId=cySysBlockSucu05button0010006Biz.insertDataSettings(baseUserList.get(0),cySysBlockSucu05button0010006);
    ...
    @PathVariable String ids) {
        ...
        cySysBlockSucu05button0010006Biz.deleteDataSettings(ids);
        if(tokenRefreshFlag) {
        	param.put("access_token", token);
        	param.put("refresh_token", refreshtoken);
    ...
    @RequestBody CySysBlockSucu05button0010006 cySysBlockSucu05button0010006) {
        ...
        cySysBlockSucu05button0010006Biz.updateDataSettings(baseUserList.get(0),cySysBlockSucu05button0010006);
        if(tokenRefreshFlag) {
        	param.put("access_token", token);
        	param.put("refresh_token", refreshtoken);
    ...
    @PathVariable String id) {
        ...
        CySysBlockSucu05button0010006 cySysBlockSucu05button0010006 = cySysBlockSucu05button0010006Biz.getDataSettings(id);
        if(tokenRefreshFlag) {
        	param.put("access_token", token);
        	param.put("refresh_token", refreshtoken);
        	 
		}
        return ResultGenerator.genSuccessResult(cySysBlockSucu05button0010006,param);
    ...
    @RequestBody CySysBlockSucu05button0010006 cySysBlockSucu05button0010006) {
        ...
        List<CySysBlockSucu05button0010006> cySysBlockSucu05button0010006lst = cySysBlockSucu05button0010006Biz.getDataSettingsByCondition(cySysBlockSucu05button0010006);
        if(tokenRefreshFlag) {
        	param.put("access_token", token);
        	param.put("refresh_token", refreshtoken);
        	 
		}
        return ResultGenerator.genSuccessResult(cySysBlockSucu05button0010006lst,param);
    ...
    @RequestParam(defaultValue = "0") Integer page, @RequestParam(defaultValue = "0") Integer size) {
        ...
        try{
         PageInfo pageInfo=cySysBlockSucu05button0010006Biz.getPageDataSettings(page,size);
        if(tokenRefreshFlag) {
        	param.put("access_token", token);
        	param.put("refresh_token", refreshtoken);
    ...
    @RequestParam(defaultValue = "0") Integer page, @RequestParam(defaultValue = "0") Integer size,@RequestBody CySysBlockSucu05button0010006 cySysBlockSucu05button0010006) {
        ...
        try{
         PageInfo pageInfo=cySysBlockSucu05button0010006Biz.getPageDataSettingsByCondition(page,size,baseUserList.get(0),cySysBlockSucu05button0010006);
        if(tokenRefreshFlag) {
        	param.put("access_token", token);
        	param.put("refresh_token", refreshtoken);
