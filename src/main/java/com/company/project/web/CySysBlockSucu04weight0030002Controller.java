...
*/
@RestController
@RequestMapping("/cysysblocksucu04weight0030002")
public class CySysBlockSucu04weight0030002Controller {
	private final Log logger = LogFactory.getLog(getClass());
	
    @Resource
    private CySysBlockSucu04weight0030002Biz cySysBlockSucu04weight0030002Biz;
    ...
    @RequestBody CySysBlockSucu04weight0030002 cySysBlockSucu04weight0030002) {
        ...
        String insertId=cySysBlockSucu04weight0030002Biz.insertDataSettings(baseUserList.get(0),cySysBlockSucu04weight0030002);
    ...
    @PathVariable String ids) {
        ...
        cySysBlockSucu04weight0030002Biz.deleteDataSettings(ids);
        if(tokenRefreshFlag) {
        	param.put("access_token", token);
        	param.put("refresh_token", refreshtoken);
    ...
    @RequestBody CySysBlockSucu04weight0030002 cySysBlockSucu04weight0030002) {
        ...
        cySysBlockSucu04weight0030002Biz.updateDataSettings(baseUserList.get(0),cySysBlockSucu04weight0030002);
        if(tokenRefreshFlag) {
        	param.put("access_token", token);
        	param.put("refresh_token", refreshtoken);
    ...
    @PathVariable String id) {
        ...
        CySysBlockSucu04weight0030002 cySysBlockSucu04weight0030002 = cySysBlockSucu04weight0030002Biz.getDataSettings(id);
        if(tokenRefreshFlag) {
        	param.put("access_token", token);
        	param.put("refresh_token", refreshtoken);
        	 
		}
        return ResultGenerator.genSuccessResult(cySysBlockSucu04weight0030002,param);
    ...
    @RequestBody CySysBlockSucu04weight0030002 cySysBlockSucu04weight0030002) {
        ...
        List<CySysBlockSucu04weight0030002> cySysBlockSucu04weight0030002lst = cySysBlockSucu04weight0030002Biz.getDataSettingsByCondition(cySysBlockSucu04weight0030002);
        if(tokenRefreshFlag) {
        	param.put("access_token", token);
        	param.put("refresh_token", refreshtoken);
        	 
		}
        return ResultGenerator.genSuccessResult(cySysBlockSucu04weight0030002lst,param);
    ...
    @RequestParam(defaultValue = "0") Integer page, @RequestParam(defaultValue = "0") Integer size) {
        ...
        try{
         PageInfo pageInfo=cySysBlockSucu04weight0030002Biz.getPageDataSettings(page,size);
        if(tokenRefreshFlag) {
        	param.put("access_token", token);
        	param.put("refresh_token", refreshtoken);
    ...
    @RequestParam(defaultValue = "0") Integer page, @RequestParam(defaultValue = "0") Integer size,@RequestBody CySysBlockSucu04weight0030002 cySysBlockSucu04weight0030002) {
        ...
        try{
         PageInfo pageInfo=cySysBlockSucu04weight0030002Biz.getPageDataSettingsByCondition(page,size,baseUserList.get(0),cySysBlockSucu04weight0030002);
        if(tokenRefreshFlag) {
        	param.put("access_token", token);
        	param.put("refresh_token", refreshtoken);
