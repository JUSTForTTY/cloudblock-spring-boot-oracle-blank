...
*/
@RestController
@RequestMapping("/cysysblocksucu08searchweiget0030003")
public class CySysBlockSucu08searchweiget0030003Controller {
	private final Log logger = LogFactory.getLog(getClass());
	
    @Resource
    private CySysBlockSucu08searchweiget0030003Biz cySysBlockSucu08searchweiget0030003Biz;
    ...
    @RequestBody CySysBlockSucu08searchweiget0030003 cySysBlockSucu08searchweiget0030003) {
        ...
        String insertId=cySysBlockSucu08searchweiget0030003Biz.insertDataSettings(baseUserList.get(0),cySysBlockSucu08searchweiget0030003);
    ...
    @PathVariable String ids) {
        ...
        cySysBlockSucu08searchweiget0030003Biz.deleteDataSettings(ids);
        if(tokenRefreshFlag) {
        	param.put("access_token", token);
        	param.put("refresh_token", refreshtoken);
    ...
    @RequestBody CySysBlockSucu08searchweiget0030003 cySysBlockSucu08searchweiget0030003) {
        ...
        cySysBlockSucu08searchweiget0030003Biz.updateDataSettings(baseUserList.get(0),cySysBlockSucu08searchweiget0030003);
        if(tokenRefreshFlag) {
        	param.put("access_token", token);
        	param.put("refresh_token", refreshtoken);
    ...
    @PathVariable String id) {
        ...
        CySysBlockSucu08searchweiget0030003 cySysBlockSucu08searchweiget0030003 = cySysBlockSucu08searchweiget0030003Biz.getDataSettings(id);
        if(tokenRefreshFlag) {
        	param.put("access_token", token);
        	param.put("refresh_token", refreshtoken);
        	 
		}
        return ResultGenerator.genSuccessResult(cySysBlockSucu08searchweiget0030003,param);
    ...
    @RequestBody CySysBlockSucu08searchweiget0030003 cySysBlockSucu08searchweiget0030003) {
        ...
        List<CySysBlockSucu08searchweiget0030003> cySysBlockSucu08searchweiget0030003lst = cySysBlockSucu08searchweiget0030003Biz.getDataSettingsByCondition(cySysBlockSucu08searchweiget0030003);
        if(tokenRefreshFlag) {
        	param.put("access_token", token);
        	param.put("refresh_token", refreshtoken);
        	 
		}
        return ResultGenerator.genSuccessResult(cySysBlockSucu08searchweiget0030003lst,param);
    ...
    @RequestParam(defaultValue = "0") Integer page, @RequestParam(defaultValue = "0") Integer size) {
        ...
        try{
         PageInfo pageInfo=cySysBlockSucu08searchweiget0030003Biz.getPageDataSettings(page,size);
        if(tokenRefreshFlag) {
        	param.put("access_token", token);
        	param.put("refresh_token", refreshtoken);
    ...
    @RequestParam(defaultValue = "0") Integer page, @RequestParam(defaultValue = "0") Integer size,@RequestBody CySysBlockSucu08searchweiget0030003 cySysBlockSucu08searchweiget0030003) {
        ...
        try{
         PageInfo pageInfo=cySysBlockSucu08searchweiget0030003Biz.getPageDataSettingsByCondition(page,size,baseUserList.get(0),cySysBlockSucu08searchweiget0030003);
        if(tokenRefreshFlag) {
        	param.put("access_token", token);
        	param.put("refresh_token", refreshtoken);
