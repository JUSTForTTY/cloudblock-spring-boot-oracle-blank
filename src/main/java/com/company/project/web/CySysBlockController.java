 ...
 */
@RestController
@RequestMapping("/cysysblock")
public class CySysBlockController {
	private final Log logger = LogFactory.getLog(getClass());

	@Resource
	private CySysBlockBiz cySysBlockBiz;
	...
	public Result insertSettingsData(@RequestHeader(value = "access_token") String access_token,
			@RequestHeader(value = "refresh_token") String refresh_token, @RequestBody CySysBlock cySysBlock) {
		...
		try {
			...
			String insertId = cySysBlockBiz.insertDataSettings(baseUserList.get(0), cySysBlock);
	...
	public Result delete(@RequestHeader(value = "access_token") String access_token,
		...
		try {
			...
			cySysBlockBiz.deleteDataSettings(ids);
			if (tokenRefreshFlag) {
				param.put("access_token", token);
				param.put("refresh_token", refreshtoken);
	...
	public Result update(@RequestHeader(value = "access_token") String access_token,
		...
		try {
			...
			cySysBlockBiz.updateDataSettings(baseUserList.get(0), cySysBlock);
			if (tokenRefreshFlag) {
				param.put("access_token", token);
				param.put("refresh_token", refreshtoken);
	...
	public Result detail(@RequestHeader(value = "access_token") String access_token,
		...
		try {
			...
			CySysBlock cySysBlock = cySysBlockBiz.getDataSettings(id);
			if (tokenRefreshFlag) {
				param.put("access_token", token);
				param.put("refresh_token", refreshtoken);

			}
			return ResultGenerator.genSuccessResult(cySysBlock, param);
	...
	public Result detailByCondition(@RequestHeader(value = "access_token") String access_token,
		...
		try {
			...
			List<CySysBlock> cySysBlocklst = cySysBlockBiz.getDataSettingsByCondition(cySysBlock);
			if (tokenRefreshFlag) {
				param.put("access_token", token);
				param.put("refresh_token", refreshtoken);

			}
			return ResultGenerator.genSuccessResult(cySysBlocklst, param);
	...
	public Result list(@RequestHeader(value = "access_token") String access_token,
		...
		try {
			PageInfo pageInfo = cySysBlockBiz.getPageDataSettings(page, size);
			if (tokenRefreshFlag) {
				param.put("access_token", token);
				param.put("refresh_token", refreshtoken);
	...
	public Result listByCondition(@RequestHeader(value = "access_token") String access_token,
			@RequestHeader(value = "refresh_token") String refresh_token,
			@RequestParam(defaultValue = "0") Integer page, @RequestParam(defaultValue = "0") Integer size,
			@RequestBody CySysBlock cySysBlock) {
		...
		try {
			Map<String, Object> map = cySysBlockBiz.getPageDataSettingsByCondition(page, size, baseUserList.get(0),
					cySysBlock);
			if (tokenRefreshFlag) {
				param.put("access_token", token);
				param.put("refresh_token", refreshtoken);
			...
			return ResultGenerator.genSuccessResult(map, param);
