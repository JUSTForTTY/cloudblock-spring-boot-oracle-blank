...
*/
@RestController
@RequestMapping("/cysysblocksucu04weight0010006")
public class CySysBlockSucu04weight0010006Controller {
	private final Log logger = LogFactory.getLog(getClass());
	
    @Resource
    private CySysBlockSucu04weight0010006Biz cySysBlockSucu04weight0010006Biz;
    ...
    @RequestBody CySysBlockSucu04weight0010006 cySysBlockSucu04weight0010006) {
        ...
        String insertId=cySysBlockSucu04weight0010006Biz.insertDataSettings(baseUserList.get(0),cySysBlockSucu04weight0010006);
    ...
    @PathVariable String ids) {
        ...
        cySysBlockSucu04weight0010006Biz.deleteDataSettings(ids);
        if(tokenRefreshFlag) {
        	param.put("access_token", token);
        	param.put("refresh_token", refreshtoken);
    ...
    @RequestBody CySysBlockSucu04weight0010006 cySysBlockSucu04weight0010006) {
        ...
        cySysBlockSucu04weight0010006Biz.updateDataSettings(baseUserList.get(0),cySysBlockSucu04weight0010006);
        if(tokenRefreshFlag) {
        	param.put("access_token", token);
        	param.put("refresh_token", refreshtoken);
    ...
    @PathVariable String id) {
        ...
        CySysBlockSucu04weight0010006 cySysBlockSucu04weight0010006 = cySysBlockSucu04weight0010006Biz.getDataSettings(id);
        if(tokenRefreshFlag) {
        	param.put("access_token", token);
        	param.put("refresh_token", refreshtoken);
        	 
		}
        return ResultGenerator.genSuccessResult(cySysBlockSucu04weight0010006,param);
    ...
    @RequestBody CySysBlockSucu04weight0010006 cySysBlockSucu04weight0010006) {
        ...
        List<CySysBlockSucu04weight0010006> cySysBlockSucu04weight0010006lst = cySysBlockSucu04weight0010006Biz.getDataSettingsByCondition(cySysBlockSucu04weight0010006);
        if(tokenRefreshFlag) {
        	param.put("access_token", token);
        	param.put("refresh_token", refreshtoken);
        	 
		}
        return ResultGenerator.genSuccessResult(cySysBlockSucu04weight0010006lst,param);
    ...
    @RequestParam(defaultValue = "0") Integer page, @RequestParam(defaultValue = "0") Integer size) {
        ...
        try{
         PageInfo pageInfo=cySysBlockSucu04weight0010006Biz.getPageDataSettings(page,size);
        if(tokenRefreshFlag) {
        	param.put("access_token", token);
        	param.put("refresh_token", refreshtoken);
    ...
    @RequestParam(defaultValue = "0") Integer page, @RequestParam(defaultValue = "0") Integer size,@RequestBody CySysBlockSucu04weight0010006 cySysBlockSucu04weight0010006) {
        ...
        try{
         PageInfo pageInfo=cySysBlockSucu04weight0010006Biz.getPageDataSettingsByCondition(page,size,baseUserList.get(0),cySysBlockSucu04weight0010006);
        if(tokenRefreshFlag) {
        	param.put("access_token", token);
        	param.put("refresh_token", refreshtoken);
