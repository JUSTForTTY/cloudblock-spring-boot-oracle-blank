...
*/
@RestController
@RequestMapping("/csysmenuauth")
public class CsysMenuAuthController {
    ...
    @RequestBody CsysMenuAuth csysMenuAuth) {
        ...
        String insertId=csysMenuAuthBiz.insertDataSettings(baseUserList.get(0),csysMenuAuth);
    ...
    @PathVariable String ids) {
        ...
        csysMenuAuthBiz.deleteDataSettings(ids);
        if(tokenRefreshFlag) {
        	param.put("access_token", token);
        	param.put("refresh_token", refreshtoken);
    ...
    @RequestBody CsysMenuAuth csysMenuAuth) {
        ...
        csysMenuAuthBiz.updateDataSettings(baseUserList.get(0),csysMenuAuth);
        if(tokenRefreshFlag) {
        	param.put("access_token", token);
        	param.put("refresh_token", refreshtoken);
    ...
    @PathVariable String id) {
        ...
        CsysMenuAuth csysMenuAuth = csysMenuAuthBiz.getDataSettings(id);
        if(tokenRefreshFlag) {
        	param.put("access_token", token);
        	param.put("refresh_token", refreshtoken);
        	 
		}
        return ResultGenerator.genSuccessResult(csysMenuAuth,param);
    ...
    @RequestBody CsysMenuAuth csysMenuAuth) {
        ...
        List<CsysMenuAuth> csysMenuAuthlst = csysMenuAuthBiz.getDataSettingsByCondition(csysMenuAuth);
        if(tokenRefreshFlag) {
        	param.put("access_token", token);
        	param.put("refresh_token", refreshtoken);
        	 
		}
        return ResultGenerator.genSuccessResult(csysMenuAuthlst,param);
    ...
    @RequestParam(defaultValue = "0") Integer page, @RequestParam(defaultValue = "0") Integer size) {
        ...
        try{
         PageInfo pageInfo=csysMenuAuthBiz.getPageDataSettings(page,size);
        if(tokenRefreshFlag) {
        	param.put("access_token", token);
        	param.put("refresh_token", refreshtoken);
    ...
    @RequestParam(defaultValue = "0") Integer page, @RequestParam(defaultValue = "0") Integer size,@RequestBody CsysMenuAuth csysMenuAuth) {
        ...
        try{
         PageInfo pageInfo=csysMenuAuthBiz.getPageDataSettingsByCondition(page,size,baseUserList.get(0),csysMenuAuth);
        if(tokenRefreshFlag) {
        	param.put("access_token", token);
        	param.put("refresh_token", refreshtoken);
