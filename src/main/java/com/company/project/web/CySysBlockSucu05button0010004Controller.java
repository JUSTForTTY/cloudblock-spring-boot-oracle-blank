...
*/
@RestController
@RequestMapping("/cysysblocksucu05button0010004")
public class CySysBlockSucu05button0010004Controller {
	private final Log logger = LogFactory.getLog(getClass());
	
    @Resource
    private CySysBlockSucu05button0010004Biz cySysBlockSucu05button0010004Biz;
    ...
    @RequestBody CySysBlockSucu05button0010004 cySysBlockSucu05button0010004) {
        ...
        String insertId=cySysBlockSucu05button0010004Biz.insertDataSettings(baseUserList.get(0),cySysBlockSucu05button0010004);
    ...
    @PathVariable String ids) {
        ...
        cySysBlockSucu05button0010004Biz.deleteDataSettings(ids);
        if(tokenRefreshFlag) {
        	param.put("access_token", token);
        	param.put("refresh_token", refreshtoken);
    ...
    @RequestBody CySysBlockSucu05button0010004 cySysBlockSucu05button0010004) {
        ...
        cySysBlockSucu05button0010004Biz.updateDataSettings(baseUserList.get(0),cySysBlockSucu05button0010004);
        if(tokenRefreshFlag) {
        	param.put("access_token", token);
        	param.put("refresh_token", refreshtoken);
    ...
    @PathVariable String id) {
        ...
        CySysBlockSucu05button0010004 cySysBlockSucu05button0010004 = cySysBlockSucu05button0010004Biz.getDataSettings(id);
        if(tokenRefreshFlag) {
        	param.put("access_token", token);
        	param.put("refresh_token", refreshtoken);
        	 
		}
        return ResultGenerator.genSuccessResult(cySysBlockSucu05button0010004,param);
    ...
    @RequestBody CySysBlockSucu05button0010004 cySysBlockSucu05button0010004) {
        ...
        List<CySysBlockSucu05button0010004> cySysBlockSucu05button0010004lst = cySysBlockSucu05button0010004Biz.getDataSettingsByCondition(cySysBlockSucu05button0010004);
        if(tokenRefreshFlag) {
        	param.put("access_token", token);
        	param.put("refresh_token", refreshtoken);
        	 
		}
        return ResultGenerator.genSuccessResult(cySysBlockSucu05button0010004lst,param);
    ...
    @RequestParam(defaultValue = "0") Integer page, @RequestParam(defaultValue = "0") Integer size) {
        ...
        try{
         PageInfo pageInfo=cySysBlockSucu05button0010004Biz.getPageDataSettings(page,size);
        if(tokenRefreshFlag) {
        	param.put("access_token", token);
        	param.put("refresh_token", refreshtoken);
    ...
    @RequestParam(defaultValue = "0") Integer page, @RequestParam(defaultValue = "0") Integer size,@RequestBody CySysBlockSucu05button0010004 cySysBlockSucu05button0010004) {
        ...
        try{
         PageInfo pageInfo=cySysBlockSucu05button0010004Biz.getPageDataSettingsByCondition(page,size,baseUserList.get(0),cySysBlockSucu05button0010004);
        if(tokenRefreshFlag) {
        	param.put("access_token", token);
        	param.put("refresh_token", refreshtoken);
