...
*/
@RestController
@RequestMapping("/cysysbaseuserrole")
public class CySysBaseUserRoleController {
	private final Log logger = LogFactory.getLog(getClass());
	
    @Resource
    private CySysBaseUserRoleBiz cySysBaseUserRoleBiz;
    ...
    @RequestBody CySysBaseUserRole cySysBaseUserRole) {
        ...
        String insertId=cySysBaseUserRoleBiz.insertDataSettings(baseUserList.get(0),cySysBaseUserRole);
    ...
    @PathVariable String ids) {
        ...
        cySysBaseUserRoleBiz.deleteDataSettings(ids);
        if(tokenRefreshFlag) {
        	param.put("access_token", token);
        	param.put("refresh_token", refreshtoken);
    ...
    @RequestBody CySysBaseUserRole cySysBaseUserRole) {
        ...
        cySysBaseUserRoleBiz.updateDataSettings(baseUserList.get(0),cySysBaseUserRole);
        if(tokenRefreshFlag) {
        	param.put("access_token", token);
        	param.put("refresh_token", refreshtoken);
    ...
    @PathVariable String id) {
        ...
        CySysBaseUserRole cySysBaseUserRole = cySysBaseUserRoleBiz.getDataSettings(id);
        if(tokenRefreshFlag) {
        	param.put("access_token", token);
        	param.put("refresh_token", refreshtoken);
        	 
		}
        return ResultGenerator.genSuccessResult(cySysBaseUserRole,param);
    ...
    @RequestBody CySysBaseUserRole cySysBaseUserRole) {
        ...
        List<CySysBaseUserRole> cySysBaseUserRolelst = cySysBaseUserRoleBiz.getDataSettingsByCondition(cySysBaseUserRole);
        if(tokenRefreshFlag) {
        	param.put("access_token", token);
        	param.put("refresh_token", refreshtoken);
        	 
		}
        return ResultGenerator.genSuccessResult(cySysBaseUserRolelst,param);
    ...
    @RequestParam(defaultValue = "0") Integer page, @RequestParam(defaultValue = "0") Integer size) {
        ...
        try{
         PageInfo pageInfo=cySysBaseUserRoleBiz.getPageDataSettings(page,size);
        if(tokenRefreshFlag) {
        	param.put("access_token", token);
        	param.put("refresh_token", refreshtoken);
    ...
    @RequestParam(defaultValue = "0") Integer page, @RequestParam(defaultValue = "0") Integer size,@RequestBody CySysBaseUserRole cySysBaseUserRole) {
        ...
        try{
         PageInfo pageInfo=cySysBaseUserRoleBiz.getPageDataSettingsByCondition(page,size,baseUserList.get(0),cySysBaseUserRole);
        if(tokenRefreshFlag) {
        	param.put("access_token", token);
        	param.put("refresh_token", refreshtoken);
