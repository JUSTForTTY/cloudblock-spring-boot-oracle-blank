...
*/
@RestController
@RequestMapping("/cysysproject")
public class CySysProjectController {
    ...
    @RequestBody CySysProject cySysProject) {
        ...
        cySysProjectBiz.insertDataSettings(baseUserList.get(0),cySysProject);
    ...
    @PathVariable String ids) {
        ...
        cySysProjectBiz.deleteDataSettings(ids);
        if(tokenRefreshFlag) {
        	param.put("access_token", token);
        	param.put("refresh_token", refreshtoken);
    ...
    @RequestBody CySysProject cySysProject) {
        ...
        cySysProjectBiz.updateDataSettings(baseUserList.get(0),cySysProject);
        if(tokenRefreshFlag) {
        	param.put("access_token", token);
        	param.put("refresh_token", refreshtoken);
    ...
    @PathVariable String id) {
        ...
        CySysProject cySysProject = cySysProjectBiz.getDataSettings(id);
        if(tokenRefreshFlag) {
        	param.put("access_token", token);
        	param.put("refresh_token", refreshtoken);
        	 
		}
        return ResultGenerator.genSuccessResult(cySysProject,param);
    ...
    @RequestBody CySysProject cySysProject) {
        ...
        List<CySysProject> cySysProjectlst = cySysProjectBiz.getDataSettingsByCondition(cySysProject);
        if(tokenRefreshFlag) {
        	param.put("access_token", token);
        	param.put("refresh_token", refreshtoken);
        	 
		}
        return ResultGenerator.genSuccessResult(cySysProjectlst,param);
    ...
    @RequestParam(defaultValue = "0") Integer page, @RequestParam(defaultValue = "0") Integer size) {
        ...
        try{
         PageInfo pageInfo=cySysProjectBiz.getPageDataSettings(page,size);
        if(tokenRefreshFlag) {
        	param.put("access_token", token);
        	param.put("refresh_token", refreshtoken);
    ...
    @RequestParam(defaultValue = "0") Integer page, @RequestParam(defaultValue = "0") Integer size,@RequestBody CySysProject cySysProject) {
        ...
        try{
         PageInfo pageInfo=cySysProjectBiz.getPageDataSettingsByCondition(page,size,baseUserList.get(0),cySysProject);
        if(tokenRefreshFlag) {
        	param.put("access_token", token);
        	param.put("refresh_token", refreshtoken);
