...
*/
@RestController
@RequestMapping("/cysysblocksucu04weight0010002")
public class CySysBlockSucu04weight0010002Controller {
	private final Log logger = LogFactory.getLog(getClass());
	
    @Resource
    private CySysBlockSucu04weight0010002Biz cySysBlockSucu04weight0010002Biz;
    ...
    @RequestBody CySysBlockSucu04weight0010002 cySysBlockSucu04weight0010002) {
        ...
        String insertId=cySysBlockSucu04weight0010002Biz.insertDataSettings(baseUserList.get(0),cySysBlockSucu04weight0010002);
    ...
    @PathVariable String ids) {
        ...
        cySysBlockSucu04weight0010002Biz.deleteDataSettings(ids);
        if(tokenRefreshFlag) {
        	param.put("access_token", token);
        	param.put("refresh_token", refreshtoken);
    ...
    @RequestBody CySysBlockSucu04weight0010002 cySysBlockSucu04weight0010002) {
        ...
        cySysBlockSucu04weight0010002Biz.updateDataSettings(baseUserList.get(0),cySysBlockSucu04weight0010002);
        if(tokenRefreshFlag) {
        	param.put("access_token", token);
        	param.put("refresh_token", refreshtoken);
    ...
    @PathVariable String id) {
        ...
        CySysBlockSucu04weight0010002 cySysBlockSucu04weight0010002 = cySysBlockSucu04weight0010002Biz.getDataSettings(id);
        if(tokenRefreshFlag) {
        	param.put("access_token", token);
        	param.put("refresh_token", refreshtoken);
        	 
		}
        return ResultGenerator.genSuccessResult(cySysBlockSucu04weight0010002,param);
    ...
    @RequestBody CySysBlockSucu04weight0010002 cySysBlockSucu04weight0010002) {
        ...
        List<CySysBlockSucu04weight0010002> cySysBlockSucu04weight0010002lst = cySysBlockSucu04weight0010002Biz.getDataSettingsByCondition(cySysBlockSucu04weight0010002);
        if(tokenRefreshFlag) {
        	param.put("access_token", token);
        	param.put("refresh_token", refreshtoken);
        	 
		}
        return ResultGenerator.genSuccessResult(cySysBlockSucu04weight0010002lst,param);
    ...
    @RequestParam(defaultValue = "0") Integer page, @RequestParam(defaultValue = "0") Integer size) {
        ...
        try{
         PageInfo pageInfo=cySysBlockSucu04weight0010002Biz.getPageDataSettings(page,size);
        if(tokenRefreshFlag) {
        	param.put("access_token", token);
        	param.put("refresh_token", refreshtoken);
    ...
    @RequestParam(defaultValue = "0") Integer page, @RequestParam(defaultValue = "0") Integer size,@RequestBody CySysBlockSucu04weight0010002 cySysBlockSucu04weight0010002) {
        ...
        try{
         PageInfo pageInfo=cySysBlockSucu04weight0010002Biz.getPageDataSettingsByCondition(page,size,baseUserList.get(0),cySysBlockSucu04weight0010002);
        if(tokenRefreshFlag) {
        	param.put("access_token", token);
        	param.put("refresh_token", refreshtoken);
