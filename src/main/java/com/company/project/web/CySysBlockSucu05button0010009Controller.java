...
*/
@RestController
@RequestMapping("/cysysblocksucu05button0010009")
public class CySysBlockSucu05button0010009Controller {
	private final Log logger = LogFactory.getLog(getClass());
	
    @Resource
    private CySysBlockSucu05button0010009Biz cySysBlockSucu05button0010009Biz;
    ...
    @RequestBody CySysBlockSucu05button0010009 cySysBlockSucu05button0010009) {
        ...
        String insertId=cySysBlockSucu05button0010009Biz.insertDataSettings(baseUserList.get(0),cySysBlockSucu05button0010009);
    ...
    @PathVariable String ids) {
        ...
        cySysBlockSucu05button0010009Biz.deleteDataSettings(ids);
        if(tokenRefreshFlag) {
        	param.put("access_token", token);
        	param.put("refresh_token", refreshtoken);
    ...
    @RequestBody CySysBlockSucu05button0010009 cySysBlockSucu05button0010009) {
        ...
        cySysBlockSucu05button0010009Biz.updateDataSettings(baseUserList.get(0),cySysBlockSucu05button0010009);
        if(tokenRefreshFlag) {
        	param.put("access_token", token);
        	param.put("refresh_token", refreshtoken);
    ...
    @PathVariable String id) {
        ...
        CySysBlockSucu05button0010009 cySysBlockSucu05button0010009 = cySysBlockSucu05button0010009Biz.getDataSettings(id);
        if(tokenRefreshFlag) {
        	param.put("access_token", token);
        	param.put("refresh_token", refreshtoken);
        	 
		}
        return ResultGenerator.genSuccessResult(cySysBlockSucu05button0010009,param);
    ...
    @RequestBody CySysBlockSucu05button0010009 cySysBlockSucu05button0010009) {
        ...
        List<CySysBlockSucu05button0010009> cySysBlockSucu05button0010009lst = cySysBlockSucu05button0010009Biz.getDataSettingsByCondition(cySysBlockSucu05button0010009);
        if(tokenRefreshFlag) {
        	param.put("access_token", token);
        	param.put("refresh_token", refreshtoken);
        	 
		}
        return ResultGenerator.genSuccessResult(cySysBlockSucu05button0010009lst,param);
    ...
    @RequestParam(defaultValue = "0") Integer page, @RequestParam(defaultValue = "0") Integer size) {
        ...
        try{
         PageInfo pageInfo=cySysBlockSucu05button0010009Biz.getPageDataSettings(page,size);
        if(tokenRefreshFlag) {
        	param.put("access_token", token);
        	param.put("refresh_token", refreshtoken);
    ...
    @RequestParam(defaultValue = "0") Integer page, @RequestParam(defaultValue = "0") Integer size,@RequestBody CySysBlockSucu05button0010009 cySysBlockSucu05button0010009) {
        ...
        try{
         PageInfo pageInfo=cySysBlockSucu05button0010009Biz.getPageDataSettingsByCondition(page,size,baseUserList.get(0),cySysBlockSucu05button0010009);
        if(tokenRefreshFlag) {
        	param.put("access_token", token);
        	param.put("refresh_token", refreshtoken);
