...
*/
@RestController
@RequestMapping("/cysysbaseuserproject")
public class CySysBaseUserProjectController {
	private final Log logger = LogFactory.getLog(getClass());
	
    @Resource
    private CySysBaseUserProjectBiz cySysBaseUserProjectBiz;
    ...
    @RequestBody CySysBaseUserProject cySysBaseUserProject) {
        ...
        cySysBaseUserProjectBiz.insertDataSettings(baseUserList.get(0),cySysBaseUserProject);
    ...
    @PathVariable String ids) {
        ...
        cySysBaseUserProjectBiz.deleteDataSettings(ids);
        if(tokenRefreshFlag) {
        	param.put("access_token", token);
        	param.put("refresh_token", refreshtoken);
    ...
    @RequestBody CySysBaseUserProject cySysBaseUserProject) {
        ...
        cySysBaseUserProjectBiz.updateDataSettings(baseUserList.get(0),cySysBaseUserProject);
        if(tokenRefreshFlag) {
        	param.put("access_token", token);
        	param.put("refresh_token", refreshtoken);
    ...
    @PathVariable String id) {
        ...
        CySysBaseUserProject cySysBaseUserProject = cySysBaseUserProjectBiz.getDataSettings(id);
        if(tokenRefreshFlag) {
        	param.put("access_token", token);
        	param.put("refresh_token", refreshtoken);
        	 
		}
        return ResultGenerator.genSuccessResult(cySysBaseUserProject,param);
    ...
    @RequestBody CySysBaseUserProject cySysBaseUserProject) {
        ...
        List<CySysBaseUserProject> cySysBaseUserProjectlst = cySysBaseUserProjectBiz.getDataSettingsByCondition(cySysBaseUserProject);
        if(tokenRefreshFlag) {
        	param.put("access_token", token);
        	param.put("refresh_token", refreshtoken);
        	 
		}
        return ResultGenerator.genSuccessResult(cySysBaseUserProjectlst,param);
    ...
    @RequestParam(defaultValue = "0") Integer page, @RequestParam(defaultValue = "0") Integer size) {
        ...
        try{
         PageInfo pageInfo=cySysBaseUserProjectBiz.getPageDataSettings(page,size);
        if(tokenRefreshFlag) {
        	param.put("access_token", token);
        	param.put("refresh_token", refreshtoken);
    ...
    @RequestParam(defaultValue = "0") Integer page, @RequestParam(defaultValue = "0") Integer size,@RequestBody CySysBaseUserProject cySysBaseUserProject) {
        ...
        try{
         PageInfo pageInfo=cySysBaseUserProjectBiz.getPageDataSettingsByCondition(page,size,baseUserList.get(0),cySysBaseUserProject);
        if(tokenRefreshFlag) {
        	param.put("access_token", token);
        	param.put("refresh_token", refreshtoken);
