...
*/
@RestController
@RequestMapping("/csysworkflow")
public class CsysWorkflowController {
	private final Log logger = LogFactory.getLog(getClass());
	
    @Resource
    private CsysWorkflowBiz csysWorkflowBiz;
    ...
    @RequestBody CsysWorkflow csysWorkflow) {
        ...
        String insertId=csysWorkflowBiz.insertDataSettings(baseUserList.get(0),csysWorkflow);
    ...
    @PathVariable String ids) {
        ...
        csysWorkflowBiz.deleteDataSettings(ids);
        if(tokenRefreshFlag) {
        	param.put("access_token", token);
        	param.put("refresh_token", refreshtoken);
    ...
    @RequestBody CsysWorkflow csysWorkflow) {
        ...
        csysWorkflowBiz.updateDataSettings(baseUserList.get(0),csysWorkflow);
        if(tokenRefreshFlag) {
        	param.put("access_token", token);
        	param.put("refresh_token", refreshtoken);
    ...
    @PathVariable String id) {
        ...
        CsysWorkflow csysWorkflow = csysWorkflowBiz.getDataSettings(id);
        if(tokenRefreshFlag) {
        	param.put("access_token", token);
        	param.put("refresh_token", refreshtoken);
        	 
		}
        return ResultGenerator.genSuccessResult(csysWorkflow,param);
    ...
    @RequestBody CsysWorkflow csysWorkflow) {
        ...
        List<CsysWorkflow> csysWorkflowlst = csysWorkflowBiz.getDataSettingsByCondition(csysWorkflow);
        if(tokenRefreshFlag) {
        	param.put("access_token", token);
        	param.put("refresh_token", refreshtoken);
        	 
		}
        return ResultGenerator.genSuccessResult(csysWorkflowlst,param);
    ...
    @RequestParam(defaultValue = "0") Integer page, @RequestParam(defaultValue = "0") Integer size) {
        ...
        try{
         PageInfo pageInfo=csysWorkflowBiz.getPageDataSettings(page,size);
        if(tokenRefreshFlag) {
        	param.put("access_token", token);
        	param.put("refresh_token", refreshtoken);
    ...
    @RequestParam(defaultValue = "0") Integer page, @RequestParam(defaultValue = "0") Integer size,@RequestBody CsysWorkflow csysWorkflow) {
        ...
        try{
         PageInfo pageInfo=csysWorkflowBiz.getPageDataSettingsByCondition(page,size,baseUserList.get(0),csysWorkflow);
        if(tokenRefreshFlag) {
        	param.put("access_token", token);
        	param.put("refresh_token", refreshtoken);
    ...
    @RequestParam(defaultValue = "0") Integer page, @RequestParam(defaultValue = "0") Integer size,@RequestBody CsysWorkflow csysWorkflow) {
        ...
        try{
         PageInfo pageInfo=csysWorkflowBiz.getSearchPageDataSettingsByCondition(page,size,baseUserList.get(0),csysWorkflow);
        if(tokenRefreshFlag) {
        	param.put("access_token", token);
        	param.put("refresh_token", refreshtoken);
