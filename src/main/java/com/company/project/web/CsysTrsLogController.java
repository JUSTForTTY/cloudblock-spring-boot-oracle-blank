...
*/
@RestController
@RequestMapping("/csystrslog")
public class CsysTrsLogController {
    ...
    @RequestBody CsysTrsLog csysTrsLog) {
        ...
        String insertId=csysTrsLogBiz.insertDataSettings(baseUserList.get(0),csysTrsLog);
    ...
    @PathVariable String ids) {
        ...
        csysTrsLogBiz.deleteDataSettings(ids);
        if(tokenRefreshFlag) {
        	param.put("access_token", token);
        	param.put("refresh_token", refreshtoken);
    ...
    @RequestBody CsysTrsLog csysTrsLog) {
        ...
        csysTrsLogBiz.updateDataSettings(baseUserList.get(0),csysTrsLog);
        if(tokenRefreshFlag) {
        	param.put("access_token", token);
        	param.put("refresh_token", refreshtoken);
    ...
    @PathVariable String id) {
        ...
        CsysTrsLog csysTrsLog = csysTrsLogBiz.getDataSettings(id);
        if(tokenRefreshFlag) {
        	param.put("access_token", token);
        	param.put("refresh_token", refreshtoken);
        	 
		}
        return ResultGenerator.genSuccessResult(csysTrsLog,param);
    ...
    @RequestBody CsysTrsLog csysTrsLog) {
        ...
        List<CsysTrsLog> csysTrsLoglst = csysTrsLogBiz.getDataSettingsByCondition(csysTrsLog);
        if(tokenRefreshFlag) {
        	param.put("access_token", token);
        	param.put("refresh_token", refreshtoken);
        	 
		}
        return ResultGenerator.genSuccessResult(csysTrsLoglst,param);
    ...
    @RequestParam(defaultValue = "0") Integer page, @RequestParam(defaultValue = "0") Integer size) {
        ...
        try{
         PageInfo pageInfo=csysTrsLogBiz.getPageDataSettings(page,size);
        if(tokenRefreshFlag) {
        	param.put("access_token", token);
        	param.put("refresh_token", refreshtoken);
    ...
    @RequestParam(defaultValue = "0") Integer page, @RequestParam(defaultValue = "0") Integer size,@RequestBody CsysTrsLog csysTrsLog) {
        ...
        try{
         PageInfo pageInfo=csysTrsLogBiz.getPageDataSettingsByCondition(page,size,baseUserList.get(0),csysTrsLog);
        if(tokenRefreshFlag) {
        	param.put("access_token", token);
        	param.put("refresh_token", refreshtoken);
