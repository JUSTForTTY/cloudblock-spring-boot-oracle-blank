...
*/
@RestController
@RequestMapping("/cysysblocksucu04weight0030007")
public class CySysBlockSucu04weight0030007Controller {
	private final Log logger = LogFactory.getLog(getClass());
	
    @Resource
    private CySysBlockSucu04weight0030007Biz cySysBlockSucu04weight0030007Biz;
    ...
    @RequestBody CySysBlockSucu04weight0030007 cySysBlockSucu04weight0030007) {
        ...
        String insertId=cySysBlockSucu04weight0030007Biz.insertDataSettings(baseUserList.get(0),cySysBlockSucu04weight0030007);
    ...
    @PathVariable String ids) {
        ...
        cySysBlockSucu04weight0030007Biz.deleteDataSettings(ids);
        if(tokenRefreshFlag) {
        	param.put("access_token", token);
        	param.put("refresh_token", refreshtoken);
    ...
    @RequestBody CySysBlockSucu04weight0030007 cySysBlockSucu04weight0030007) {
        ...
        cySysBlockSucu04weight0030007Biz.updateDataSettings(baseUserList.get(0),cySysBlockSucu04weight0030007);
        if(tokenRefreshFlag) {
        	param.put("access_token", token);
        	param.put("refresh_token", refreshtoken);
    ...
    @PathVariable String id) {
        ...
        CySysBlockSucu04weight0030007 cySysBlockSucu04weight0030007 = cySysBlockSucu04weight0030007Biz.getDataSettings(id);
        if(tokenRefreshFlag) {
        	param.put("access_token", token);
        	param.put("refresh_token", refreshtoken);
        	 
		}
        return ResultGenerator.genSuccessResult(cySysBlockSucu04weight0030007,param);
    ...
    @RequestBody CySysBlockSucu04weight0030007 cySysBlockSucu04weight0030007) {
        ...
        List<CySysBlockSucu04weight0030007> cySysBlockSucu04weight0030007lst = cySysBlockSucu04weight0030007Biz.getDataSettingsByCondition(cySysBlockSucu04weight0030007);
        if(tokenRefreshFlag) {
        	param.put("access_token", token);
        	param.put("refresh_token", refreshtoken);
        	 
		}
        return ResultGenerator.genSuccessResult(cySysBlockSucu04weight0030007lst,param);
    ...
    @RequestParam(defaultValue = "0") Integer page, @RequestParam(defaultValue = "0") Integer size) {
        ...
        try{
         PageInfo pageInfo=cySysBlockSucu04weight0030007Biz.getPageDataSettings(page,size);
        if(tokenRefreshFlag) {
        	param.put("access_token", token);
        	param.put("refresh_token", refreshtoken);
    ...
    @RequestParam(defaultValue = "0") Integer page, @RequestParam(defaultValue = "0") Integer size,@RequestBody CySysBlockSucu04weight0030007 cySysBlockSucu04weight0030007) {
        ...
        try{
         PageInfo pageInfo=cySysBlockSucu04weight0030007Biz.getPageDataSettingsByCondition(page,size,baseUserList.get(0),cySysBlockSucu04weight0030007);
        if(tokenRefreshFlag) {
        	param.put("access_token", token);
        	param.put("refresh_token", refreshtoken);
