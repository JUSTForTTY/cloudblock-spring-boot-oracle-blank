...
*/
@RestController
@RequestMapping("/csyspotgroup")
public class CsysPotGroupController {
	private final Log logger = LogFactory.getLog(getClass());
	
    @Resource
    private CsysPotGroupBiz csysPotGroupBiz;
    ...
    @RequestBody CsysPotGroup csysPotGroup) {
        ...
        String insertId=csysPotGroupBiz.insertDataSettings(baseUserList.get(0),csysPotGroup);
    ...
    @PathVariable String ids) {
        ...
        csysPotGroupBiz.deleteDataSettings(ids);
        if(tokenRefreshFlag) {
        	param.put("access_token", token);
        	param.put("refresh_token", refreshtoken);
    ...
    @RequestBody CsysPotGroup csysPotGroup) {
        ...
        csysPotGroupBiz.updateDataSettings(baseUserList.get(0),csysPotGroup);
        if(tokenRefreshFlag) {
        	param.put("access_token", token);
        	param.put("refresh_token", refreshtoken);
    ...
    @PathVariable String id) {
        ...
        CsysPotGroup csysPotGroup = csysPotGroupBiz.getDataSettings(id);
        if(tokenRefreshFlag) {
        	param.put("access_token", token);
        	param.put("refresh_token", refreshtoken);
        	 
		}
        return ResultGenerator.genSuccessResult(csysPotGroup,param);
    ...
    @RequestBody CsysPotGroup csysPotGroup) {
        ...
        List<CsysPotGroup> csysPotGrouplst = csysPotGroupBiz.getDataSettingsByCondition(csysPotGroup);
        if(tokenRefreshFlag) {
        	param.put("access_token", token);
        	param.put("refresh_token", refreshtoken);
        	 
		}
        return ResultGenerator.genSuccessResult(csysPotGrouplst,param);
    ...
    @RequestParam(defaultValue = "0") Integer page, @RequestParam(defaultValue = "0") Integer size) {
        ...
        try{
         PageInfo pageInfo=csysPotGroupBiz.getPageDataSettings(page,size);
        if(tokenRefreshFlag) {
        	param.put("access_token", token);
        	param.put("refresh_token", refreshtoken);
    ...
    @RequestParam(defaultValue = "0") Integer page, @RequestParam(defaultValue = "0") Integer size,@RequestBody CsysPotGroup csysPotGroup) {
        ...
        try{
         PageInfo pageInfo=csysPotGroupBiz.getPageDataSettingsByCondition(page,size,baseUserList.get(0),csysPotGroup);
        if(tokenRefreshFlag) {
        	param.put("access_token", token);
        	param.put("refresh_token", refreshtoken);
