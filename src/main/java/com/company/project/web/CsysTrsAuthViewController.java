...
*/
@RestController
@RequestMapping("/csystrsauthview")
public class CsysTrsAuthViewController {
    ...
    @RequestBody CsysTrsAuthView csysTrsAuthView) {
        ...
        String insertId=csysTrsAuthViewBiz.insertDataSettings(baseUserList.get(0),csysTrsAuthView);
    ...
    @PathVariable String ids) {
        ...
        csysTrsAuthViewBiz.deleteDataSettings(ids);
        if(tokenRefreshFlag) {
        	param.put("access_token", token);
        	param.put("refresh_token", refreshtoken);
    ...
    @RequestBody CsysTrsAuthView csysTrsAuthView) {
        ...
        csysTrsAuthViewBiz.updateDataSettings(baseUserList.get(0),csysTrsAuthView);
        if(tokenRefreshFlag) {
        	param.put("access_token", token);
        	param.put("refresh_token", refreshtoken);
    ...
    @PathVariable String id) {
        ...
        CsysTrsAuthView csysTrsAuthView = csysTrsAuthViewBiz.getDataSettings(id);
        if(tokenRefreshFlag) {
        	param.put("access_token", token);
        	param.put("refresh_token", refreshtoken);
        	 
		}
        return ResultGenerator.genSuccessResult(csysTrsAuthView,param);
    ...
    @RequestBody CsysTrsAuthView csysTrsAuthView) {
        ...
        List<CsysTrsAuthView> csysTrsAuthViewlst = csysTrsAuthViewBiz.getDataSettingsByCondition(csysTrsAuthView);
        if(tokenRefreshFlag) {
        	param.put("access_token", token);
        	param.put("refresh_token", refreshtoken);
        	 
		}
        return ResultGenerator.genSuccessResult(csysTrsAuthViewlst,param);
    ...
    @RequestParam(defaultValue = "0") Integer page, @RequestParam(defaultValue = "0") Integer size) {
        ...
        try{
         PageInfo pageInfo=csysTrsAuthViewBiz.getPageDataSettings(page,size);
        if(tokenRefreshFlag) {
        	param.put("access_token", token);
        	param.put("refresh_token", refreshtoken);
    ...
    @RequestParam(defaultValue = "0") Integer page, @RequestParam(defaultValue = "0") Integer size,@RequestBody CsysTrsAuthView csysTrsAuthView) {
        ...
        try{
         PageInfo pageInfo=csysTrsAuthViewBiz.getPageDataSettingsByCondition(page,size,baseUserList.get(0),csysTrsAuthView);
        if(tokenRefreshFlag) {
        	param.put("access_token", token);
        	param.put("refresh_token", refreshtoken);
