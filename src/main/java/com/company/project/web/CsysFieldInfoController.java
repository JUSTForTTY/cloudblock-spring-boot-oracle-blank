...
*/
@RestController
@RequestMapping("/csysfieldinfo")
public class CsysFieldInfoController {
    ...
    @RequestBody CsysFieldInfo csysFieldInfo) {
        ...
        String insertId=csysFieldInfoBiz.insertDataSettings(baseUserList.get(0),csysFieldInfo);
    ...
    @PathVariable String ids) {
        ...
        csysFieldInfoBiz.deleteDataSettings(ids);
        if(tokenRefreshFlag) {
        	param.put("access_token", token);
        	param.put("refresh_token", refreshtoken);
    ...
    @RequestBody CsysFieldInfo csysFieldInfo) {
        ...
        csysFieldInfoBiz.updateDataSettings(baseUserList.get(0),csysFieldInfo);
        if(tokenRefreshFlag) {
        	param.put("access_token", token);
        	param.put("refresh_token", refreshtoken);
    ...
    @PathVariable String id) {
        ...
        CsysFieldInfo csysFieldInfo = csysFieldInfoBiz.getDataSettings(id);
        if(tokenRefreshFlag) {
        	param.put("access_token", token);
        	param.put("refresh_token", refreshtoken);
        	 
		}
        return ResultGenerator.genSuccessResult(csysFieldInfo,param);
    ...
    @RequestBody CsysFieldInfo csysFieldInfo) {
        ...
        List<CsysFieldInfo> csysFieldInfolst = csysFieldInfoBiz.getDataSettingsByCondition(csysFieldInfo);
        if(tokenRefreshFlag) {
        	param.put("access_token", token);
        	param.put("refresh_token", refreshtoken);
        	 
		}
        return ResultGenerator.genSuccessResult(csysFieldInfolst,param);
    ...
    @RequestParam(defaultValue = "0") Integer page, @RequestParam(defaultValue = "0") Integer size) {
        ...
        try{
         PageInfo pageInfo=csysFieldInfoBiz.getPageDataSettings(page,size);
        if(tokenRefreshFlag) {
        	param.put("access_token", token);
        	param.put("refresh_token", refreshtoken);
    ...
    @RequestParam(defaultValue = "0") Integer page, @RequestParam(defaultValue = "0") Integer size,@RequestBody CsysFieldInfo csysFieldInfo) {
        ...
        try{
         PageInfo pageInfo=csysFieldInfoBiz.getPageDataSettingsByCondition(page,size,baseUserList.get(0),csysFieldInfo);
        if(tokenRefreshFlag) {
        	param.put("access_token", token);
        	param.put("refresh_token", refreshtoken);
