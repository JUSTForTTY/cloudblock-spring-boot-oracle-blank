...
*/
@RestController
@RequestMapping("/cysysblocksucu05button0010003")
public class CySysBlockSucu05button0010003Controller {
	private final Log logger = LogFactory.getLog(getClass());
	
    @Resource
    private CySysBlockSucu05button0010003Biz cySysBlockSucu05button0010003Biz;
    ...
    @RequestBody CySysBlockSucu05button0010003 cySysBlockSucu05button0010003) {
        ...
        String insertId=cySysBlockSucu05button0010003Biz.insertDataSettings(baseUserList.get(0),cySysBlockSucu05button0010003);
    ...
    @PathVariable String ids) {
        ...
        cySysBlockSucu05button0010003Biz.deleteDataSettings(ids);
        if(tokenRefreshFlag) {
        	param.put("access_token", token);
        	param.put("refresh_token", refreshtoken);
    ...
    @RequestBody CySysBlockSucu05button0010003 cySysBlockSucu05button0010003) {
        ...
        cySysBlockSucu05button0010003Biz.updateDataSettings(baseUserList.get(0),cySysBlockSucu05button0010003);
        if(tokenRefreshFlag) {
        	param.put("access_token", token);
        	param.put("refresh_token", refreshtoken);
    ...
    @PathVariable String id) {
        ...
        CySysBlockSucu05button0010003 cySysBlockSucu05button0010003 = cySysBlockSucu05button0010003Biz.getDataSettings(id);
        if(tokenRefreshFlag) {
        	param.put("access_token", token);
        	param.put("refresh_token", refreshtoken);
        	 
		}
        return ResultGenerator.genSuccessResult(cySysBlockSucu05button0010003,param);
    ...
    @RequestBody CySysBlockSucu05button0010003 cySysBlockSucu05button0010003) {
        ...
        List<CySysBlockSucu05button0010003> cySysBlockSucu05button0010003lst = cySysBlockSucu05button0010003Biz.getDataSettingsByCondition(cySysBlockSucu05button0010003);
        if(tokenRefreshFlag) {
        	param.put("access_token", token);
        	param.put("refresh_token", refreshtoken);
        	 
		}
        return ResultGenerator.genSuccessResult(cySysBlockSucu05button0010003lst,param);
    ...
    @RequestParam(defaultValue = "0") Integer page, @RequestParam(defaultValue = "0") Integer size) {
        ...
        try{
         PageInfo pageInfo=cySysBlockSucu05button0010003Biz.getPageDataSettings(page,size);
        if(tokenRefreshFlag) {
        	param.put("access_token", token);
        	param.put("refresh_token", refreshtoken);
    ...
    @RequestParam(defaultValue = "0") Integer page, @RequestParam(defaultValue = "0") Integer size,@RequestBody CySysBlockSucu05button0010003 cySysBlockSucu05button0010003) {
        ...
        try{
         PageInfo pageInfo=cySysBlockSucu05button0010003Biz.getPageDataSettingsByCondition(page,size,baseUserList.get(0),cySysBlockSucu05button0010003);
        if(tokenRefreshFlag) {
        	param.put("access_token", token);
        	param.put("refresh_token", refreshtoken);
