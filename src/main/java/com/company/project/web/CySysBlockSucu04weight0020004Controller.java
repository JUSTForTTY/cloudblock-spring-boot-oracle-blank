...
*/
@RestController
@RequestMapping("/cysysblocksucu04weight0020004")
public class CySysBlockSucu04weight0020004Controller {
	private final Log logger = LogFactory.getLog(getClass());
	
    @Resource
    private CySysBlockSucu04weight0020004Biz cySysBlockSucu04weight0020004Biz;
    ...
    @RequestBody CySysBlockSucu04weight0020004 cySysBlockSucu04weight0020004) {
        ...
        String insertId=cySysBlockSucu04weight0020004Biz.insertDataSettings(baseUserList.get(0),cySysBlockSucu04weight0020004);
    ...
    @PathVariable String ids) {
        ...
        cySysBlockSucu04weight0020004Biz.deleteDataSettings(ids);
        if(tokenRefreshFlag) {
        	param.put("access_token", token);
        	param.put("refresh_token", refreshtoken);
    ...
    @RequestBody CySysBlockSucu04weight0020004 cySysBlockSucu04weight0020004) {
        ...
        cySysBlockSucu04weight0020004Biz.updateDataSettings(baseUserList.get(0),cySysBlockSucu04weight0020004);
        if(tokenRefreshFlag) {
        	param.put("access_token", token);
        	param.put("refresh_token", refreshtoken);
    ...
    @PathVariable String id) {
        ...
        CySysBlockSucu04weight0020004 cySysBlockSucu04weight0020004 = cySysBlockSucu04weight0020004Biz.getDataSettings(id);
        if(tokenRefreshFlag) {
        	param.put("access_token", token);
        	param.put("refresh_token", refreshtoken);
        	 
		}
        return ResultGenerator.genSuccessResult(cySysBlockSucu04weight0020004,param);
    ...
    @RequestBody CySysBlockSucu04weight0020004 cySysBlockSucu04weight0020004) {
        ...
        List<CySysBlockSucu04weight0020004> cySysBlockSucu04weight0020004lst = cySysBlockSucu04weight0020004Biz.getDataSettingsByCondition(cySysBlockSucu04weight0020004);
        if(tokenRefreshFlag) {
        	param.put("access_token", token);
        	param.put("refresh_token", refreshtoken);
        	 
		}
        return ResultGenerator.genSuccessResult(cySysBlockSucu04weight0020004lst,param);
    ...
    @RequestParam(defaultValue = "0") Integer page, @RequestParam(defaultValue = "0") Integer size) {
        ...
        try{
         PageInfo pageInfo=cySysBlockSucu04weight0020004Biz.getPageDataSettings(page,size);
        if(tokenRefreshFlag) {
        	param.put("access_token", token);
        	param.put("refresh_token", refreshtoken);
    ...
    @RequestParam(defaultValue = "0") Integer page, @RequestParam(defaultValue = "0") Integer size,@RequestBody CySysBlockSucu04weight0020004 cySysBlockSucu04weight0020004) {
        ...
        try{
         PageInfo pageInfo=cySysBlockSucu04weight0020004Biz.getPageDataSettingsByCondition(page,size,baseUserList.get(0),cySysBlockSucu04weight0020004);
        if(tokenRefreshFlag) {
        	param.put("access_token", token);
        	param.put("refresh_token", refreshtoken);
