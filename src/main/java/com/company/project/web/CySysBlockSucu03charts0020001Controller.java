...
*/
@RestController
@RequestMapping("/cysysblocksucu03charts0020001")
public class CySysBlockSucu03charts0020001Controller {
	private final Log logger = LogFactory.getLog(getClass());
	
    @Resource
    private CySysBlockSucu03charts0020001Biz cySysBlockSucu03charts0020001Biz;
    ...
    @RequestBody CySysBlockSucu03charts0020001 cySysBlockSucu03charts0020001) {
        ...
        String insertId=cySysBlockSucu03charts0020001Biz.insertDataSettings(baseUserList.get(0),cySysBlockSucu03charts0020001);
    ...
    @PathVariable String ids) {
        ...
        cySysBlockSucu03charts0020001Biz.deleteDataSettings(ids);
        if(tokenRefreshFlag) {
        	param.put("access_token", token);
        	param.put("refresh_token", refreshtoken);
    ...
    @RequestBody CySysBlockSucu03charts0020001 cySysBlockSucu03charts0020001) {
        ...
        cySysBlockSucu03charts0020001Biz.updateDataSettings(baseUserList.get(0),cySysBlockSucu03charts0020001);
        if(tokenRefreshFlag) {
        	param.put("access_token", token);
        	param.put("refresh_token", refreshtoken);
    ...
    @PathVariable String id) {
        ...
        CySysBlockSucu03charts0020001 cySysBlockSucu03charts0020001 = cySysBlockSucu03charts0020001Biz.getDataSettings(id);
        if(tokenRefreshFlag) {
        	param.put("access_token", token);
        	param.put("refresh_token", refreshtoken);
        	 
		}
        return ResultGenerator.genSuccessResult(cySysBlockSucu03charts0020001,param);
    ...
    @RequestBody CySysBlockSucu03charts0020001 cySysBlockSucu03charts0020001) {
        ...
        List<CySysBlockSucu03charts0020001> cySysBlockSucu03charts0020001lst = cySysBlockSucu03charts0020001Biz.getDataSettingsByCondition(cySysBlockSucu03charts0020001);
        if(tokenRefreshFlag) {
        	param.put("access_token", token);
        	param.put("refresh_token", refreshtoken);
        	 
		}
        return ResultGenerator.genSuccessResult(cySysBlockSucu03charts0020001lst,param);
    ...
    @RequestParam(defaultValue = "0") Integer page, @RequestParam(defaultValue = "0") Integer size) {
        ...
        try{
         PageInfo pageInfo=cySysBlockSucu03charts0020001Biz.getPageDataSettings(page,size);
        if(tokenRefreshFlag) {
        	param.put("access_token", token);
        	param.put("refresh_token", refreshtoken);
    ...
    @RequestParam(defaultValue = "0") Integer page, @RequestParam(defaultValue = "0") Integer size,@RequestBody CySysBlockSucu03charts0020001 cySysBlockSucu03charts0020001) {
        ...
        try{
         PageInfo pageInfo=cySysBlockSucu03charts0020001Biz.getPageDataSettingsByCondition(page,size,baseUserList.get(0),cySysBlockSucu03charts0020001);
        if(tokenRefreshFlag) {
        	param.put("access_token", token);
        	param.put("refresh_token", refreshtoken);
