...
*/
@RestController
@RequestMapping("/cysysblocksucu04weight0010005")
public class CySysBlockSucu04weight0010005Controller {
	private final Log logger = LogFactory.getLog(getClass());
	
    @Resource
    private CySysBlockSucu04weight0010005Biz cySysBlockSucu04weight0010005Biz;
    ...
    @RequestBody CySysBlockSucu04weight0010005 cySysBlockSucu04weight0010005) {
        ...
        String insertId=cySysBlockSucu04weight0010005Biz.insertDataSettings(baseUserList.get(0),cySysBlockSucu04weight0010005);
    ...
    @PathVariable String ids) {
        ...
        cySysBlockSucu04weight0010005Biz.deleteDataSettings(ids);
        if(tokenRefreshFlag) {
        	param.put("access_token", token);
        	param.put("refresh_token", refreshtoken);
    ...
    @RequestBody CySysBlockSucu04weight0010005 cySysBlockSucu04weight0010005) {
        ...
        cySysBlockSucu04weight0010005Biz.updateDataSettings(baseUserList.get(0),cySysBlockSucu04weight0010005);
        if(tokenRefreshFlag) {
        	param.put("access_token", token);
        	param.put("refresh_token", refreshtoken);
    ...
    @PathVariable String id) {
        ...
        CySysBlockSucu04weight0010005 cySysBlockSucu04weight0010005 = cySysBlockSucu04weight0010005Biz.getDataSettings(id);
        if(tokenRefreshFlag) {
        	param.put("access_token", token);
        	param.put("refresh_token", refreshtoken);
        	 
		}
        return ResultGenerator.genSuccessResult(cySysBlockSucu04weight0010005,param);
    ...
    @RequestBody CySysBlockSucu04weight0010005 cySysBlockSucu04weight0010005) {
        ...
        List<CySysBlockSucu04weight0010005> cySysBlockSucu04weight0010005lst = cySysBlockSucu04weight0010005Biz.getDataSettingsByCondition(cySysBlockSucu04weight0010005);
        if(tokenRefreshFlag) {
        	param.put("access_token", token);
        	param.put("refresh_token", refreshtoken);
        	 
		}
        return ResultGenerator.genSuccessResult(cySysBlockSucu04weight0010005lst,param);
    ...
    @RequestParam(defaultValue = "0") Integer page, @RequestParam(defaultValue = "0") Integer size) {
        ...
        try{
         PageInfo pageInfo=cySysBlockSucu04weight0010005Biz.getPageDataSettings(page,size);
        if(tokenRefreshFlag) {
        	param.put("access_token", token);
        	param.put("refresh_token", refreshtoken);
    ...
    @RequestParam(defaultValue = "0") Integer page, @RequestParam(defaultValue = "0") Integer size,@RequestBody CySysBlockSucu04weight0010005 cySysBlockSucu04weight0010005) {
        ...
        try{
         PageInfo pageInfo=cySysBlockSucu04weight0010005Biz.getPageDataSettingsByCondition(page,size,baseUserList.get(0),cySysBlockSucu04weight0010005);
        if(tokenRefreshFlag) {
        	param.put("access_token", token);
        	param.put("refresh_token", refreshtoken);
