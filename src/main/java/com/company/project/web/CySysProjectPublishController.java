...
*/
@RestController
@RequestMapping("/cysysprojectpublish")
public class CySysProjectPublishController {
	private final Log logger = LogFactory.getLog(getClass());
	
    @Resource
    private CySysProjectPublishBiz cySysProjectPublishBiz;
    ...
    @RequestBody CySysProjectPublish cySysProjectPublish) {
        ...
        String insertId=cySysProjectPublishBiz.insertDataSettings(baseUserList.get(0),cySysProjectPublish);
    ...
    @PathVariable String ids) {
        ...
        cySysProjectPublishBiz.deleteDataSettings(ids);
        if(tokenRefreshFlag) {
        	param.put("access_token", token);
        	param.put("refresh_token", refreshtoken);
    ...
    @RequestBody CySysProjectPublish cySysProjectPublish) {
        ...
        cySysProjectPublishBiz.updateDataSettings(baseUserList.get(0),cySysProjectPublish);
        if(tokenRefreshFlag) {
        	param.put("access_token", token);
        	param.put("refresh_token", refreshtoken);
    ...
    @PathVariable String id) {
        ...
        CySysProjectPublish cySysProjectPublish = cySysProjectPublishBiz.getDataSettings(id);
        if(tokenRefreshFlag) {
        	param.put("access_token", token);
        	param.put("refresh_token", refreshtoken);
        	 
		}
        return ResultGenerator.genSuccessResult(cySysProjectPublish,param);
    ...
    @RequestBody CySysProjectPublish cySysProjectPublish) {
        ...
        List<CySysProjectPublish> cySysProjectPublishlst = cySysProjectPublishBiz.getDataSettingsByCondition(cySysProjectPublish);
        if(tokenRefreshFlag) {
        	param.put("access_token", token);
        	param.put("refresh_token", refreshtoken);
        	 
		}
        return ResultGenerator.genSuccessResult(cySysProjectPublishlst,param);
    ...
    @RequestParam(defaultValue = "0") Integer page, @RequestParam(defaultValue = "0") Integer size) {
        ...
        try{
         PageInfo pageInfo=cySysProjectPublishBiz.getPageDataSettings(page,size);
        if(tokenRefreshFlag) {
        	param.put("access_token", token);
        	param.put("refresh_token", refreshtoken);
    ...
    @RequestParam(defaultValue = "0") Integer page, @RequestParam(defaultValue = "0") Integer size,@RequestBody CySysProjectPublish cySysProjectPublish) {
        ...
        try{
         PageInfo pageInfo=cySysProjectPublishBiz.getPageDataSettingsByCondition(page,size,baseUserList.get(0),cySysProjectPublish);
        if(tokenRefreshFlag) {
        	param.put("access_token", token);
        	param.put("refresh_token", refreshtoken);
