...
*/
@RestController
@RequestMapping("/csyspotgropre")
public class CsysPotGroPreController {
	private final Log logger = LogFactory.getLog(getClass());
	
    @Resource
    private CsysPotGroPreBiz csysPotGroPreBiz;
    ...
    @RequestBody CsysPotGroPre csysPotGroPre) {
        ...
        String insertId=csysPotGroPreBiz.insertDataSettings(baseUserList.get(0),csysPotGroPre);
    ...
    @PathVariable String ids) {
        ...
        csysPotGroPreBiz.deleteDataSettings(ids);
        if(tokenRefreshFlag) {
        	param.put("access_token", token);
        	param.put("refresh_token", refreshtoken);
    ...
    @RequestBody CsysPotGroPre csysPotGroPre) {
        ...
        csysPotGroPreBiz.updateDataSettings(baseUserList.get(0),csysPotGroPre);
        if(tokenRefreshFlag) {
        	param.put("access_token", token);
        	param.put("refresh_token", refreshtoken);
    ...
    @PathVariable String id) {
        ...
        CsysPotGroPre csysPotGroPre = csysPotGroPreBiz.getDataSettings(id);
        if(tokenRefreshFlag) {
        	param.put("access_token", token);
        	param.put("refresh_token", refreshtoken);
        	 
		}
        return ResultGenerator.genSuccessResult(csysPotGroPre,param);
    ...
    @RequestBody CsysPotGroPre csysPotGroPre) {
        ...
        List<CsysPotGroPre> csysPotGroPrelst = csysPotGroPreBiz.getDataSettingsByCondition(csysPotGroPre);
        if(tokenRefreshFlag) {
        	param.put("access_token", token);
        	param.put("refresh_token", refreshtoken);
        	 
		}
        return ResultGenerator.genSuccessResult(csysPotGroPrelst,param);
    ...
    @RequestParam(defaultValue = "0") Integer page, @RequestParam(defaultValue = "0") Integer size) {
        ...
        try{
         PageInfo pageInfo=csysPotGroPreBiz.getPageDataSettings(page,size);
        if(tokenRefreshFlag) {
        	param.put("access_token", token);
        	param.put("refresh_token", refreshtoken);
    ...
    @RequestParam(defaultValue = "0") Integer page, @RequestParam(defaultValue = "0") Integer size,@RequestBody CsysPotGroPre csysPotGroPre) {
        ...
        try{
         PageInfo pageInfo=csysPotGroPreBiz.getPageDataSettingsByCondition(page,size,baseUserList.get(0),csysPotGroPre);
        if(tokenRefreshFlag) {
        	param.put("access_token", token);
        	param.put("refresh_token", refreshtoken);
