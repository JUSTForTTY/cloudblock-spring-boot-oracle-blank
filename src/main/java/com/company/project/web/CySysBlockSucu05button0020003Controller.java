...
*/
@RestController
@RequestMapping("/cysysblocksucu05button0020003")
public class CySysBlockSucu05button0020003Controller {
	private final Log logger = LogFactory.getLog(getClass());
	
    @Resource
    private CySysBlockSucu05button0020003Biz cySysBlockSucu05button0020003Biz;
    ...
    @RequestBody CySysBlockSucu05button0020003 cySysBlockSucu05button0020003) {
        ...
        String insertId=cySysBlockSucu05button0020003Biz.insertDataSettings(baseUserList.get(0),cySysBlockSucu05button0020003);
    ...
    @PathVariable String ids) {
        ...
        cySysBlockSucu05button0020003Biz.deleteDataSettings(ids);
        if(tokenRefreshFlag) {
        	param.put("access_token", token);
        	param.put("refresh_token", refreshtoken);
    ...
    @RequestBody CySysBlockSucu05button0020003 cySysBlockSucu05button0020003) {
        ...
        cySysBlockSucu05button0020003Biz.updateDataSettings(baseUserList.get(0),cySysBlockSucu05button0020003);
        if(tokenRefreshFlag) {
        	param.put("access_token", token);
        	param.put("refresh_token", refreshtoken);
    ...
    @PathVariable String id) {
        ...
        CySysBlockSucu05button0020003 cySysBlockSucu05button0020003 = cySysBlockSucu05button0020003Biz.getDataSettings(id);
        if(tokenRefreshFlag) {
        	param.put("access_token", token);
        	param.put("refresh_token", refreshtoken);
        	 
		}
        return ResultGenerator.genSuccessResult(cySysBlockSucu05button0020003,param);
    ...
    @RequestBody CySysBlockSucu05button0020003 cySysBlockSucu05button0020003) {
        ...
        List<CySysBlockSucu05button0020003> cySysBlockSucu05button0020003lst = cySysBlockSucu05button0020003Biz.getDataSettingsByCondition(cySysBlockSucu05button0020003);
        if(tokenRefreshFlag) {
        	param.put("access_token", token);
        	param.put("refresh_token", refreshtoken);
        	 
		}
        return ResultGenerator.genSuccessResult(cySysBlockSucu05button0020003lst,param);
    ...
    @RequestParam(defaultValue = "0") Integer page, @RequestParam(defaultValue = "0") Integer size) {
        ...
        try{
         PageInfo pageInfo=cySysBlockSucu05button0020003Biz.getPageDataSettings(page,size);
        if(tokenRefreshFlag) {
        	param.put("access_token", token);
        	param.put("refresh_token", refreshtoken);
    ...
    @RequestParam(defaultValue = "0") Integer page, @RequestParam(defaultValue = "0") Integer size,@RequestBody CySysBlockSucu05button0020003 cySysBlockSucu05button0020003) {
        ...
        try{
         PageInfo pageInfo=cySysBlockSucu05button0020003Biz.getPageDataSettingsByCondition(page,size,baseUserList.get(0),cySysBlockSucu05button0020003);
        if(tokenRefreshFlag) {
        	param.put("access_token", token);
        	param.put("refresh_token", refreshtoken);
