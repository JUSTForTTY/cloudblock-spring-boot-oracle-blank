...
*/
@RestController
@RequestMapping("/cysysblocksucu07innerweiget0010003")
public class CySysBlockSucu07innerweiget0010003Controller {
	private final Log logger = LogFactory.getLog(getClass());
	
    @Resource
    private CySysBlockSucu07innerweiget0010003Biz cySysBlockSucu07innerweiget0010003Biz;
    ...
    @RequestBody CySysBlockSucu07innerweiget0010003 cySysBlockSucu07innerweiget0010003) {
        ...
        String insertId=cySysBlockSucu07innerweiget0010003Biz.insertDataSettings(baseUserList.get(0),cySysBlockSucu07innerweiget0010003);
    ...
    @PathVariable String ids) {
        ...
        cySysBlockSucu07innerweiget0010003Biz.deleteDataSettings(ids);
        if(tokenRefreshFlag) {
        	param.put("access_token", token);
        	param.put("refresh_token", refreshtoken);
    ...
    @RequestBody CySysBlockSucu07innerweiget0010003 cySysBlockSucu07innerweiget0010003) {
        ...
        cySysBlockSucu07innerweiget0010003Biz.updateDataSettings(baseUserList.get(0),cySysBlockSucu07innerweiget0010003);
        if(tokenRefreshFlag) {
        	param.put("access_token", token);
        	param.put("refresh_token", refreshtoken);
    ...
    @PathVariable String id) {
        ...
        CySysBlockSucu07innerweiget0010003 cySysBlockSucu07innerweiget0010003 = cySysBlockSucu07innerweiget0010003Biz.getDataSettings(id);
        if(tokenRefreshFlag) {
        	param.put("access_token", token);
        	param.put("refresh_token", refreshtoken);
        	 
		}
        return ResultGenerator.genSuccessResult(cySysBlockSucu07innerweiget0010003,param);
    ...
    @RequestBody CySysBlockSucu07innerweiget0010003 cySysBlockSucu07innerweiget0010003) {
        ...
        List<CySysBlockSucu07innerweiget0010003> cySysBlockSucu07innerweiget0010003lst = cySysBlockSucu07innerweiget0010003Biz.getDataSettingsByCondition(cySysBlockSucu07innerweiget0010003);
        if(tokenRefreshFlag) {
        	param.put("access_token", token);
        	param.put("refresh_token", refreshtoken);
        	 
		}
        return ResultGenerator.genSuccessResult(cySysBlockSucu07innerweiget0010003lst,param);
    ...
    @RequestParam(defaultValue = "0") Integer page, @RequestParam(defaultValue = "0") Integer size) {
        ...
        try{
         PageInfo pageInfo=cySysBlockSucu07innerweiget0010003Biz.getPageDataSettings(page,size);
        if(tokenRefreshFlag) {
        	param.put("access_token", token);
        	param.put("refresh_token", refreshtoken);
    ...
    @RequestParam(defaultValue = "0") Integer page, @RequestParam(defaultValue = "0") Integer size,@RequestBody CySysBlockSucu07innerweiget0010003 cySysBlockSucu07innerweiget0010003) {
        ...
        try{
         PageInfo pageInfo=cySysBlockSucu07innerweiget0010003Biz.getPageDataSettingsByCondition(page,size,baseUserList.get(0),cySysBlockSucu07innerweiget0010003);
        if(tokenRefreshFlag) {
        	param.put("access_token", token);
        	param.put("refresh_token", refreshtoken);
