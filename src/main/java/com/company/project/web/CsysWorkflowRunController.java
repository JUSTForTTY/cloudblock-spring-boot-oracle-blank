...
*/
@RestController
@RequestMapping("/csysworkflowrun")
public class CsysWorkflowRunController {
    ...
    @RequestBody CsysWorkflowRun csysWorkflowRun) {
        ...
        String insertId=csysWorkflowRunBiz.insertDataSettings(baseUserList.get(0),csysWorkflowRun);
    ...
    @PathVariable String ids) {
        ...
        csysWorkflowRunBiz.deleteDataSettings(ids);
        if(tokenRefreshFlag) {
        	param.put("access_token", token);
        	param.put("refresh_token", refreshtoken);
    ...
    @RequestBody CsysWorkflowRun csysWorkflowRun) {
        ...
        csysWorkflowRunBiz.updateDataSettings(baseUserList.get(0),csysWorkflowRun);
        if(tokenRefreshFlag) {
        	param.put("access_token", token);
        	param.put("refresh_token", refreshtoken);
    ...
    @PathVariable String id) {
        ...
        CsysWorkflowRun csysWorkflowRun = csysWorkflowRunBiz.getDataSettings(id);
        if(tokenRefreshFlag) {
        	param.put("access_token", token);
        	param.put("refresh_token", refreshtoken);
        	 
		}
        return ResultGenerator.genSuccessResult(csysWorkflowRun,param);
    ...
    @RequestBody CsysWorkflowRun csysWorkflowRun) {
        ...
        List<CsysWorkflowRun> csysWorkflowRunlst = csysWorkflowRunBiz.getDataSettingsByCondition(csysWorkflowRun);
        if(tokenRefreshFlag) {
        	param.put("access_token", token);
        	param.put("refresh_token", refreshtoken);
        	 
		}
        return ResultGenerator.genSuccessResult(csysWorkflowRunlst,param);
    ...
    @RequestParam(defaultValue = "0") Integer page, @RequestParam(defaultValue = "0") Integer size) {
        ...
        try{
         PageInfo pageInfo=csysWorkflowRunBiz.getPageDataSettings(page,size);
        if(tokenRefreshFlag) {
        	param.put("access_token", token);
        	param.put("refresh_token", refreshtoken);
    ...
    @RequestParam(defaultValue = "0") Integer page, @RequestParam(defaultValue = "0") Integer size,@RequestBody CsysWorkflowRun csysWorkflowRun) {
        ...
        try{
         PageInfo pageInfo=csysWorkflowRunBiz.getPageDataSettingsByCondition(page,size,baseUserList.get(0),csysWorkflowRun);
        if(tokenRefreshFlag) {
        	param.put("access_token", token);
        	param.put("refresh_token", refreshtoken);
