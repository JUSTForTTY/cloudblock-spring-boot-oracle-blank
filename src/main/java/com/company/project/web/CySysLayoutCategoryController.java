...
*/
@RestController
@RequestMapping("/cysyslayoutcategory")
public class CySysLayoutCategoryController {
	private final Log logger = LogFactory.getLog(getClass());
	
    @Resource
    private CySysLayoutCategoryBiz cySysLayoutCategoryBiz;
    ...
    @RequestBody CySysLayoutCategory cySysLayoutCategory) {
        ...
        cySysLayoutCategoryBiz.insertDataSettings(baseUserList.get(0),cySysLayoutCategory);
    ...
    @PathVariable String ids) {
        ...
        cySysLayoutCategoryBiz.deleteDataSettings(ids);
        if(tokenRefreshFlag) {
        	param.put("access_token", token);
        	param.put("refresh_token", refreshtoken);
    ...
    @RequestBody CySysLayoutCategory cySysLayoutCategory) {
        ...
        cySysLayoutCategoryBiz.updateDataSettings(baseUserList.get(0),cySysLayoutCategory);
        if(tokenRefreshFlag) {
        	param.put("access_token", token);
        	param.put("refresh_token", refreshtoken);
    ...
    @PathVariable String id) {
        ...
        CySysLayoutCategory cySysLayoutCategory = cySysLayoutCategoryBiz.getDataSettings(id);
        if(tokenRefreshFlag) {
        	param.put("access_token", token);
        	param.put("refresh_token", refreshtoken);
        	 
		}
        return ResultGenerator.genSuccessResult(cySysLayoutCategory,param);
    ...
    @RequestBody CySysLayoutCategory cySysLayoutCategory) {
        ...
        List<CySysLayoutCategory> cySysLayoutCategorylst = cySysLayoutCategoryBiz.getDataSettingsByCondition(cySysLayoutCategory);
        if(tokenRefreshFlag) {
        	param.put("access_token", token);
        	param.put("refresh_token", refreshtoken);
        	 
		}
        return ResultGenerator.genSuccessResult(cySysLayoutCategorylst,param);
    ...
    @RequestParam(defaultValue = "0") Integer page, @RequestParam(defaultValue = "0") Integer size) {
        ...
        try{
         PageInfo pageInfo=cySysLayoutCategoryBiz.getPageDataSettings(page,size);
        if(tokenRefreshFlag) {
        	param.put("access_token", token);
        	param.put("refresh_token", refreshtoken);
    ...
    @RequestParam(defaultValue = "0") Integer page, @RequestParam(defaultValue = "0") Integer size,@RequestBody CySysLayoutCategory cySysLayoutCategory) {
        ...
        try{
         PageInfo pageInfo=cySysLayoutCategoryBiz.getPageDataSettingsByCondition(page,size,baseUserList.get(0),cySysLayoutCategory);
        if(tokenRefreshFlag) {
        	param.put("access_token", token);
        	param.put("refresh_token", refreshtoken);
