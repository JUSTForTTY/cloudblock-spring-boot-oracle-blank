...
*/
@RestController
@RequestMapping("/csysusernotice")
public class CsysUserNoticeController {
	private final Log logger = LogFactory.getLog(getClass());
	
    @Resource
    private CsysUserNoticeBiz csysUserNoticeBiz;
    ...
    @RequestBody CsysUserNotice csysUserNotice) {
        ...
        String insertId=csysUserNoticeBiz.insertDataSettings(baseUserList.get(0),csysUserNotice);
    ...
    @PathVariable String ids) {
        ...
        csysUserNoticeBiz.deleteDataSettings(ids);
        if(tokenRefreshFlag) {
        	param.put("access_token", token);
        	param.put("refresh_token", refreshtoken);
    ...
    @RequestBody CsysUserNotice csysUserNotice) {
        ...
        csysUserNoticeBiz.updateDataSettings(baseUserList.get(0),csysUserNotice);
        if(tokenRefreshFlag) {
        	param.put("access_token", token);
        	param.put("refresh_token", refreshtoken);
    ...
    @PathVariable String id) {
        ...
        CsysUserNotice csysUserNotice = csysUserNoticeBiz.getDataSettings(id);
        if(tokenRefreshFlag) {
        	param.put("access_token", token);
        	param.put("refresh_token", refreshtoken);
        	 
		}
        return ResultGenerator.genSuccessResult(csysUserNotice,param);
    ...
    @RequestBody CsysUserNotice csysUserNotice) {
        ...
        List<CsysUserNotice> csysUserNoticelst = csysUserNoticeBiz.getDataSettingsByCondition(csysUserNotice);
        if(tokenRefreshFlag) {
        	param.put("access_token", token);
        	param.put("refresh_token", refreshtoken);
        	 
		}
        return ResultGenerator.genSuccessResult(csysUserNoticelst,param);
    ...
    @RequestParam(defaultValue = "0") Integer page, @RequestParam(defaultValue = "0") Integer size) {
        ...
        try{
         PageInfo pageInfo=csysUserNoticeBiz.getPageDataSettings(page,size);
        if(tokenRefreshFlag) {
        	param.put("access_token", token);
        	param.put("refresh_token", refreshtoken);
    ...
    @RequestParam(defaultValue = "0") Integer page, @RequestParam(defaultValue = "0") Integer size,@RequestBody CsysUserNotice csysUserNotice) {
        ...
        try{
         PageInfo pageInfo=csysUserNoticeBiz.getPageDataSettingsByCondition(page,size,baseUserList.get(0),csysUserNotice);
        if(tokenRefreshFlag) {
        	param.put("access_token", token);
        	param.put("refresh_token", refreshtoken);
