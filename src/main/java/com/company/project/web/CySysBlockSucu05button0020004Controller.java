...
*/
@RestController
@RequestMapping("/cysysblocksucu05button0020004")
public class CySysBlockSucu05button0020004Controller {
	private final Log logger = LogFactory.getLog(getClass());
	
    @Resource
    private CySysBlockSucu05button0020004Biz cySysBlockSucu05button0020004Biz;
    ...
    @RequestBody CySysBlockSucu05button0020004 cySysBlockSucu05button0020004) {
        ...
        String insertId=cySysBlockSucu05button0020004Biz.insertDataSettings(baseUserList.get(0),cySysBlockSucu05button0020004);
    ...
    @PathVariable String ids) {
        ...
        cySysBlockSucu05button0020004Biz.deleteDataSettings(ids);
        if(tokenRefreshFlag) {
        	param.put("access_token", token);
        	param.put("refresh_token", refreshtoken);
    ...
    @RequestBody CySysBlockSucu05button0020004 cySysBlockSucu05button0020004) {
        ...
        cySysBlockSucu05button0020004Biz.updateDataSettings(baseUserList.get(0),cySysBlockSucu05button0020004);
        if(tokenRefreshFlag) {
        	param.put("access_token", token);
        	param.put("refresh_token", refreshtoken);
    ...
    @PathVariable String id) {
        ...
        CySysBlockSucu05button0020004 cySysBlockSucu05button0020004 = cySysBlockSucu05button0020004Biz.getDataSettings(id);
        if(tokenRefreshFlag) {
        	param.put("access_token", token);
        	param.put("refresh_token", refreshtoken);
        	 
		}
        return ResultGenerator.genSuccessResult(cySysBlockSucu05button0020004,param);
    ...
    @RequestBody CySysBlockSucu05button0020004 cySysBlockSucu05button0020004) {
        ...
        List<CySysBlockSucu05button0020004> cySysBlockSucu05button0020004lst = cySysBlockSucu05button0020004Biz.getDataSettingsByCondition(cySysBlockSucu05button0020004);
        if(tokenRefreshFlag) {
        	param.put("access_token", token);
        	param.put("refresh_token", refreshtoken);
        	 
		}
        return ResultGenerator.genSuccessResult(cySysBlockSucu05button0020004lst,param);
    ...
    @RequestParam(defaultValue = "0") Integer page, @RequestParam(defaultValue = "0") Integer size) {
        ...
        try{
         PageInfo pageInfo=cySysBlockSucu05button0020004Biz.getPageDataSettings(page,size);
        if(tokenRefreshFlag) {
        	param.put("access_token", token);
        	param.put("refresh_token", refreshtoken);
    ...
    @RequestParam(defaultValue = "0") Integer page, @RequestParam(defaultValue = "0") Integer size,@RequestBody CySysBlockSucu05button0020004 cySysBlockSucu05button0020004) {
        ...
        try{
         PageInfo pageInfo=cySysBlockSucu05button0020004Biz.getPageDataSettingsByCondition(page,size,baseUserList.get(0),cySysBlockSucu05button0020004);
        if(tokenRefreshFlag) {
        	param.put("access_token", token);
        	param.put("refresh_token", refreshtoken);
