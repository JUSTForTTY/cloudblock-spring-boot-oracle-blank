...
*/
@RestController
@RequestMapping("/csyssequence")
public class CsysSequenceController {
    ...
    @RequestBody CsysSequence csysSequence) {
        ...
        String insertId=csysSequenceBiz.insertDataSettings(baseUserList.get(0),csysSequence);
    ...
    @PathVariable String ids) {
        ...
        csysSequenceBiz.deleteDataSettings(ids);
        if(tokenRefreshFlag) {
        	param.put("access_token", token);
        	param.put("refresh_token", refreshtoken);
    ...
    @RequestBody CsysSequence csysSequence) {
        ...
        csysSequenceBiz.updateDataSettings(baseUserList.get(0),csysSequence);
        if(tokenRefreshFlag) {
        	param.put("access_token", token);
        	param.put("refresh_token", refreshtoken);
    ...
    @PathVariable String id) {
        ...
        CsysSequence csysSequence = csysSequenceBiz.getDataSettings(id);
        if(tokenRefreshFlag) {
        	param.put("access_token", token);
        	param.put("refresh_token", refreshtoken);
        	 
		}
        return ResultGenerator.genSuccessResult(csysSequence,param);
    ...
    @RequestBody CsysSequence csysSequence) {
        ...
        List<CsysSequence> csysSequencelst = csysSequenceBiz.getDataSettingsByCondition(csysSequence);
        if(tokenRefreshFlag) {
        	param.put("access_token", token);
        	param.put("refresh_token", refreshtoken);
        	 
		}
        return ResultGenerator.genSuccessResult(csysSequencelst,param);
    ...
    @RequestParam(defaultValue = "0") Integer page, @RequestParam(defaultValue = "0") Integer size) {
        ...
        try{
         PageInfo pageInfo=csysSequenceBiz.getPageDataSettings(page,size);
        if(tokenRefreshFlag) {
        	param.put("access_token", token);
        	param.put("refresh_token", refreshtoken);
    ...
    @RequestParam(defaultValue = "0") Integer page, @RequestParam(defaultValue = "0") Integer size,@RequestBody CsysSequence csysSequence) {
        ...
        try{
         PageInfo pageInfo=csysSequenceBiz.getPageDataSettingsByCondition(page,size,baseUserList.get(0),csysSequence);
        if(tokenRefreshFlag) {
        	param.put("access_token", token);
        	param.put("refresh_token", refreshtoken);
