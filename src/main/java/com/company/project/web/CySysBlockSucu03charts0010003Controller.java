...
*/
@RestController
@RequestMapping("/cysysblocksucu03charts0010003")
public class CySysBlockSucu03charts0010003Controller {
	private final Log logger = LogFactory.getLog(getClass());
	
    @Resource
    private CySysBlockSucu03charts0010003Biz cySysBlockSucu03charts0010003Biz;
    ...
    @RequestBody CySysBlockSucu03charts0010003 cySysBlockSucu03charts0010003) {
        ...
        String insertId=cySysBlockSucu03charts0010003Biz.insertDataSettings(baseUserList.get(0),cySysBlockSucu03charts0010003);
    ...
    @PathVariable String ids) {
        ...
        cySysBlockSucu03charts0010003Biz.deleteDataSettings(ids);
        if(tokenRefreshFlag) {
        	param.put("access_token", token);
        	param.put("refresh_token", refreshtoken);
    ...
    @RequestBody CySysBlockSucu03charts0010003 cySysBlockSucu03charts0010003) {
        ...
        cySysBlockSucu03charts0010003Biz.updateDataSettings(baseUserList.get(0),cySysBlockSucu03charts0010003);
        if(tokenRefreshFlag) {
        	param.put("access_token", token);
        	param.put("refresh_token", refreshtoken);
    ...
    @PathVariable String id) {
        ...
        CySysBlockSucu03charts0010003 cySysBlockSucu03charts0010003 = cySysBlockSucu03charts0010003Biz.getDataSettings(id);
        if(tokenRefreshFlag) {
        	param.put("access_token", token);
        	param.put("refresh_token", refreshtoken);
        	 
		}
        return ResultGenerator.genSuccessResult(cySysBlockSucu03charts0010003,param);
    ...
    @RequestBody CySysBlockSucu03charts0010003 cySysBlockSucu03charts0010003) {
        ...
        List<CySysBlockSucu03charts0010003> cySysBlockSucu03charts0010003lst = cySysBlockSucu03charts0010003Biz.getDataSettingsByCondition(cySysBlockSucu03charts0010003);
        if(tokenRefreshFlag) {
        	param.put("access_token", token);
        	param.put("refresh_token", refreshtoken);
        	 
		}
        return ResultGenerator.genSuccessResult(cySysBlockSucu03charts0010003lst,param);
    ...
    @RequestParam(defaultValue = "0") Integer page, @RequestParam(defaultValue = "0") Integer size) {
        ...
        try{
         PageInfo pageInfo=cySysBlockSucu03charts0010003Biz.getPageDataSettings(page,size);
        if(tokenRefreshFlag) {
        	param.put("access_token", token);
        	param.put("refresh_token", refreshtoken);
    ...
    @RequestParam(defaultValue = "0") Integer page, @RequestParam(defaultValue = "0") Integer size,@RequestBody CySysBlockSucu03charts0010003 cySysBlockSucu03charts0010003) {
        ...
        try{
         PageInfo pageInfo=cySysBlockSucu03charts0010003Biz.getPageDataSettingsByCondition(page,size,baseUserList.get(0),cySysBlockSucu03charts0010003);
        if(tokenRefreshFlag) {
        	param.put("access_token", token);
        	param.put("refresh_token", refreshtoken);
