...
*/
@RestController
@RequestMapping("/csyspottrs")
public class CsysPotTrsController {
    ...
    @RequestBody CsysPotTrs csysPotTrs) {
        ...
        String insertId=csysPotTrsBiz.insertDataSettings(baseUserList.get(0),csysPotTrs);
    ...
    @PathVariable String ids) {
        ...
        csysPotTrsBiz.deleteDataSettings(ids);
        if(tokenRefreshFlag) {
        	param.put("access_token", token);
        	param.put("refresh_token", refreshtoken);
    ...
    @RequestBody CsysPotTrs csysPotTrs) {
        ...
        csysPotTrsBiz.updateDataSettings(baseUserList.get(0),csysPotTrs);
        if(tokenRefreshFlag) {
        	param.put("access_token", token);
        	param.put("refresh_token", refreshtoken);
    ...
    @PathVariable String id) {
        ...
        CsysPotTrs csysPotTrs = csysPotTrsBiz.getDataSettings(id);
        if(tokenRefreshFlag) {
        	param.put("access_token", token);
        	param.put("refresh_token", refreshtoken);
        	 
		}
        return ResultGenerator.genSuccessResult(csysPotTrs,param);
    ...
    @RequestParam(defaultValue = "0") Integer page, @RequestParam(defaultValue = "0") Integer size) {
        ...
        try{
         PageInfo pageInfo=csysPotTrsBiz.getPageDataSettings(page,size);
        if(tokenRefreshFlag) {
        	param.put("access_token", token);
        	param.put("refresh_token", refreshtoken);
    ...
    @RequestParam(defaultValue = "0") Integer page, @RequestParam(defaultValue = "0") Integer size,@RequestBody CsysPotTrs csysPotTrs) {
        ...
        try{
         PageInfo pageInfo=csysPotTrsBiz.getPageDataSettingsByCondition(page,size,baseUserList.get(0),csysPotTrs);
        if(tokenRefreshFlag) {
        	param.put("access_token", token);
        	param.put("refresh_token", refreshtoken);
