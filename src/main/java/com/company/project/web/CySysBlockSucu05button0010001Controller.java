...
*/
@RestController
@RequestMapping("/cysysblocksucu05button0010001")
public class CySysBlockSucu05button0010001Controller {
	private final Log logger = LogFactory.getLog(getClass());
	
    @Resource
    private CySysBlockSucu05button0010001Biz cySysBlockSucu05button0010001Biz;
    ...
    @RequestBody CySysBlockSucu05button0010001 cySysBlockSucu05button0010001) {
        ...
        String insertId=cySysBlockSucu05button0010001Biz.insertDataSettings(baseUserList.get(0),cySysBlockSucu05button0010001);
    ...
    @PathVariable String ids) {
        ...
        cySysBlockSucu05button0010001Biz.deleteDataSettings(ids);
        if(tokenRefreshFlag) {
        	param.put("access_token", token);
        	param.put("refresh_token", refreshtoken);
    ...
    @RequestBody CySysBlockSucu05button0010001 cySysBlockSucu05button0010001) {
        ...
        cySysBlockSucu05button0010001Biz.updateDataSettings(baseUserList.get(0),cySysBlockSucu05button0010001);
        if(tokenRefreshFlag) {
        	param.put("access_token", token);
        	param.put("refresh_token", refreshtoken);
    ...
    @PathVariable String id) {
        ...
        CySysBlockSucu05button0010001 cySysBlockSucu05button0010001 = cySysBlockSucu05button0010001Biz.getDataSettings(id);
        if(tokenRefreshFlag) {
        	param.put("access_token", token);
        	param.put("refresh_token", refreshtoken);
        	 
		}
        return ResultGenerator.genSuccessResult(cySysBlockSucu05button0010001,param);
    ...
    @RequestBody CySysBlockSucu05button0010001 cySysBlockSucu05button0010001) {
        ...
        List<CySysBlockSucu05button0010001> cySysBlockSucu05button0010001lst = cySysBlockSucu05button0010001Biz.getDataSettingsByCondition(cySysBlockSucu05button0010001);
        if(tokenRefreshFlag) {
        	param.put("access_token", token);
        	param.put("refresh_token", refreshtoken);
        	 
		}
        return ResultGenerator.genSuccessResult(cySysBlockSucu05button0010001lst,param);
    ...
    @RequestParam(defaultValue = "0") Integer page, @RequestParam(defaultValue = "0") Integer size) {
        ...
        try{
         PageInfo pageInfo=cySysBlockSucu05button0010001Biz.getPageDataSettings(page,size);
        if(tokenRefreshFlag) {
        	param.put("access_token", token);
        	param.put("refresh_token", refreshtoken);
    ...
    @RequestParam(defaultValue = "0") Integer page, @RequestParam(defaultValue = "0") Integer size,@RequestBody CySysBlockSucu05button0010001 cySysBlockSucu05button0010001) {
        ...
        try{
         PageInfo pageInfo=cySysBlockSucu05button0010001Biz.getPageDataSettingsByCondition(page,size,baseUserList.get(0),cySysBlockSucu05button0010001);
        if(tokenRefreshFlag) {
        	param.put("access_token", token);
        	param.put("refresh_token", refreshtoken);
