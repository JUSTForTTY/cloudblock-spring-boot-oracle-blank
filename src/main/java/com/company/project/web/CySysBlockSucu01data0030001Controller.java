...
*/
@RestController
@RequestMapping("/cysysblocksucu01data0030001")
public class CySysBlockSucu01data0030001Controller {
	private final Log logger = LogFactory.getLog(getClass());
	
    @Resource
    private CySysBlockSucu01data0030001Biz cySysBlockSucu01data0030001Biz;
    ...
    @RequestBody CySysBlockSucu01data0030001 cySysBlockSucu01data0030001) {
        ...
        String insertId=cySysBlockSucu01data0030001Biz.insertDataSettings(baseUserList.get(0),cySysBlockSucu01data0030001);
    ...
    @PathVariable String ids) {
        ...
        cySysBlockSucu01data0030001Biz.deleteDataSettings(ids);
        if(tokenRefreshFlag) {
        	param.put("access_token", token);
        	param.put("refresh_token", refreshtoken);
    ...
    @RequestBody CySysBlockSucu01data0030001 cySysBlockSucu01data0030001) {
        ...
        cySysBlockSucu01data0030001Biz.updateDataSettings(baseUserList.get(0),cySysBlockSucu01data0030001);
        if(tokenRefreshFlag) {
        	param.put("access_token", token);
        	param.put("refresh_token", refreshtoken);
    ...
    @PathVariable String id) {
        ...
        CySysBlockSucu01data0030001 cySysBlockSucu01data0030001 = cySysBlockSucu01data0030001Biz.getDataSettings(id);
        if(tokenRefreshFlag) {
        	param.put("access_token", token);
        	param.put("refresh_token", refreshtoken);
        	 
		}
        return ResultGenerator.genSuccessResult(cySysBlockSucu01data0030001,param);
    ...
    @RequestBody CySysBlockSucu01data0030001 cySysBlockSucu01data0030001) {
        ...
        List<CySysBlockSucu01data0030001> cySysBlockSucu01data0030001lst = cySysBlockSucu01data0030001Biz.getDataSettingsByCondition(cySysBlockSucu01data0030001);
        if(tokenRefreshFlag) {
        	param.put("access_token", token);
        	param.put("refresh_token", refreshtoken);
        	 
		}
        return ResultGenerator.genSuccessResult(cySysBlockSucu01data0030001lst,param);
    ...
    @RequestParam(defaultValue = "0") Integer page, @RequestParam(defaultValue = "0") Integer size) {
        ...
        try{
         PageInfo pageInfo=cySysBlockSucu01data0030001Biz.getPageDataSettings(page,size);
        if(tokenRefreshFlag) {
        	param.put("access_token", token);
        	param.put("refresh_token", refreshtoken);
    ...
    @RequestParam(defaultValue = "0") Integer page, @RequestParam(defaultValue = "0") Integer size,@RequestBody CySysBlockSucu01data0030001 cySysBlockSucu01data0030001) {
        ...
        try{
         PageInfo pageInfo=cySysBlockSucu01data0030001Biz.getPageDataSettingsByCondition(page,size,baseUserList.get(0),cySysBlockSucu01data0030001);
        if(tokenRefreshFlag) {
        	param.put("access_token", token);
        	param.put("refresh_token", refreshtoken);
