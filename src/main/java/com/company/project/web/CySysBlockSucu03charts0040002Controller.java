...
*/
@RestController
@RequestMapping("/cysysblocksucu03charts0040002")
public class CySysBlockSucu03charts0040002Controller {
	private final Log logger = LogFactory.getLog(getClass());
	
    @Resource
    private CySysBlockSucu03charts0040002Biz cySysBlockSucu03charts0040002Biz;
    ...
    @RequestBody CySysBlockSucu03charts0040002 cySysBlockSucu03charts0040002) {
        ...
        String insertId=cySysBlockSucu03charts0040002Biz.insertDataSettings(baseUserList.get(0),cySysBlockSucu03charts0040002);
    ...
    @PathVariable String ids) {
        ...
        cySysBlockSucu03charts0040002Biz.deleteDataSettings(ids);
        if(tokenRefreshFlag) {
        	param.put("access_token", token);
        	param.put("refresh_token", refreshtoken);
    ...
    @RequestBody CySysBlockSucu03charts0040002 cySysBlockSucu03charts0040002) {
        ...
        cySysBlockSucu03charts0040002Biz.updateDataSettings(baseUserList.get(0),cySysBlockSucu03charts0040002);
        if(tokenRefreshFlag) {
        	param.put("access_token", token);
        	param.put("refresh_token", refreshtoken);
    ...
    @PathVariable String id) {
        ...
        CySysBlockSucu03charts0040002 cySysBlockSucu03charts0040002 = cySysBlockSucu03charts0040002Biz.getDataSettings(id);
        if(tokenRefreshFlag) {
        	param.put("access_token", token);
        	param.put("refresh_token", refreshtoken);
        	 
		}
        return ResultGenerator.genSuccessResult(cySysBlockSucu03charts0040002,param);
    ...
    @RequestBody CySysBlockSucu03charts0040002 cySysBlockSucu03charts0040002) {
        ...
        List<CySysBlockSucu03charts0040002> cySysBlockSucu03charts0040002lst = cySysBlockSucu03charts0040002Biz.getDataSettingsByCondition(cySysBlockSucu03charts0040002);
        if(tokenRefreshFlag) {
        	param.put("access_token", token);
        	param.put("refresh_token", refreshtoken);
        	 
		}
        return ResultGenerator.genSuccessResult(cySysBlockSucu03charts0040002lst,param);
    ...
    @RequestParam(defaultValue = "0") Integer page, @RequestParam(defaultValue = "0") Integer size) {
        ...
        try{
         PageInfo pageInfo=cySysBlockSucu03charts0040002Biz.getPageDataSettings(page,size);
        if(tokenRefreshFlag) {
        	param.put("access_token", token);
        	param.put("refresh_token", refreshtoken);
    ...
    @RequestParam(defaultValue = "0") Integer page, @RequestParam(defaultValue = "0") Integer size,@RequestBody CySysBlockSucu03charts0040002 cySysBlockSucu03charts0040002) {
        ...
        try{
         PageInfo pageInfo=cySysBlockSucu03charts0040002Biz.getPageDataSettingsByCondition(page,size,baseUserList.get(0),cySysBlockSucu03charts0040002);
        if(tokenRefreshFlag) {
        	param.put("access_token", token);
        	param.put("refresh_token", refreshtoken);
