...
*/
@RestController
@RequestMapping("/csyssimplepage")
public class CsysSimplePageController {
	private final Log logger = LogFactory.getLog(getClass());
	
    @Resource
    private CsysSimplePageBiz csysSimplePageBiz;
    ...
    @RequestBody CsysSimplePage csysSimplePage) {
        ...
        String insertId=csysSimplePageBiz.insertDataSettings(baseUserList.get(0),csysSimplePage);
    ...
    @PathVariable String ids) {
        ...
        csysSimplePageBiz.deleteDataSettings(ids);
        if(tokenRefreshFlag) {
        	param.put("access_token", token);
        	param.put("refresh_token", refreshtoken);
    ...
    @RequestBody CsysSimplePage csysSimplePage) {
        ...
        csysSimplePageBiz.updateDataSettings(baseUserList.get(0),csysSimplePage);
        if(tokenRefreshFlag) {
        	param.put("access_token", token);
        	param.put("refresh_token", refreshtoken);
    ...
    @PathVariable String id) {
        ...
        CsysSimplePage csysSimplePage = csysSimplePageBiz.getDataSettings(id);
        if(tokenRefreshFlag) {
        	param.put("access_token", token);
        	param.put("refresh_token", refreshtoken);
        	 
		}
        return ResultGenerator.genSuccessResult(csysSimplePage,param);
    ...
    @RequestBody CsysSimplePage csysSimplePage) {
        ...
        List<CsysSimplePage> csysSimplePagelst = csysSimplePageBiz.getDataSettingsByCondition(csysSimplePage);
        if(tokenRefreshFlag) {
        	param.put("access_token", token);
        	param.put("refresh_token", refreshtoken);
        	 
		}
        return ResultGenerator.genSuccessResult(csysSimplePagelst,param);
    ...
    @RequestParam(defaultValue = "0") Integer page, @RequestParam(defaultValue = "0") Integer size) {
        ...
        try{
         PageInfo pageInfo=csysSimplePageBiz.getPageDataSettings(page,size);
        if(tokenRefreshFlag) {
        	param.put("access_token", token);
        	param.put("refresh_token", refreshtoken);
    ...
    @RequestParam(defaultValue = "0") Integer page, @RequestParam(defaultValue = "0") Integer size,@RequestBody CsysSimplePage csysSimplePage) {
        ...
        try{
         PageInfo pageInfo=csysSimplePageBiz.getPageDataSettingsByCondition(page,size,baseUserList.get(0),csysSimplePage);
        if(tokenRefreshFlag) {
        	param.put("access_token", token);
        	param.put("refresh_token", refreshtoken);
