...
*/
@RestController
@RequestMapping("/cysysblocksucu04weight0050001")
public class CySysBlockSucu04weight0050001Controller {
	private final Log logger = LogFactory.getLog(getClass());
	
    @Resource
    private CySysBlockSucu04weight0050001Biz cySysBlockSucu04weight0050001Biz;
    ...
    @RequestBody CySysBlockSucu04weight0050001 cySysBlockSucu04weight0050001) {
        ...
        String insertId=cySysBlockSucu04weight0050001Biz.insertDataSettings(baseUserList.get(0),cySysBlockSucu04weight0050001);
    ...
    @PathVariable String ids) {
        ...
        cySysBlockSucu04weight0050001Biz.deleteDataSettings(ids);
        if(tokenRefreshFlag) {
        	param.put("access_token", token);
        	param.put("refresh_token", refreshtoken);
    ...
    @RequestBody CySysBlockSucu04weight0050001 cySysBlockSucu04weight0050001) {
        ...
        cySysBlockSucu04weight0050001Biz.updateDataSettings(baseUserList.get(0),cySysBlockSucu04weight0050001);
        if(tokenRefreshFlag) {
        	param.put("access_token", token);
        	param.put("refresh_token", refreshtoken);
    ...
    @PathVariable String id) {
        ...
        CySysBlockSucu04weight0050001 cySysBlockSucu04weight0050001 = cySysBlockSucu04weight0050001Biz.getDataSettings(id);
        if(tokenRefreshFlag) {
        	param.put("access_token", token);
        	param.put("refresh_token", refreshtoken);
        	 
		}
        return ResultGenerator.genSuccessResult(cySysBlockSucu04weight0050001,param);
    ...
    @RequestBody CySysBlockSucu04weight0050001 cySysBlockSucu04weight0050001) {
        ...
        List<CySysBlockSucu04weight0050001> cySysBlockSucu04weight0050001lst = cySysBlockSucu04weight0050001Biz.getDataSettingsByCondition(cySysBlockSucu04weight0050001);
        if(tokenRefreshFlag) {
        	param.put("access_token", token);
        	param.put("refresh_token", refreshtoken);
        	 
		}
        return ResultGenerator.genSuccessResult(cySysBlockSucu04weight0050001lst,param);
    ...
    @RequestParam(defaultValue = "0") Integer page, @RequestParam(defaultValue = "0") Integer size) {
        ...
        try{
         PageInfo pageInfo=cySysBlockSucu04weight0050001Biz.getPageDataSettings(page,size);
        if(tokenRefreshFlag) {
        	param.put("access_token", token);
        	param.put("refresh_token", refreshtoken);
    ...
    @RequestParam(defaultValue = "0") Integer page, @RequestParam(defaultValue = "0") Integer size,@RequestBody CySysBlockSucu04weight0050001 cySysBlockSucu04weight0050001) {
        ...
        try{
         PageInfo pageInfo=cySysBlockSucu04weight0050001Biz.getPageDataSettingsByCondition(page,size,baseUserList.get(0),cySysBlockSucu04weight0050001);
        if(tokenRefreshFlag) {
        	param.put("access_token", token);
        	param.put("refresh_token", refreshtoken);
