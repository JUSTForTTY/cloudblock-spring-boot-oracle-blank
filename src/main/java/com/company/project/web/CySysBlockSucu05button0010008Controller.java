...
*/
@RestController
@RequestMapping("/cysysblocksucu05button0010008")
public class CySysBlockSucu05button0010008Controller {
	private final Log logger = LogFactory.getLog(getClass());
	
    @Resource
    private CySysBlockSucu05button0010008Biz cySysBlockSucu05button0010008Biz;
    ...
    @RequestBody CySysBlockSucu05button0010008 cySysBlockSucu05button0010008) {
        ...
        String insertId=cySysBlockSucu05button0010008Biz.insertDataSettings(baseUserList.get(0),cySysBlockSucu05button0010008);
    ...
    @PathVariable String ids) {
        ...
        cySysBlockSucu05button0010008Biz.deleteDataSettings(ids);
        if(tokenRefreshFlag) {
        	param.put("access_token", token);
        	param.put("refresh_token", refreshtoken);
    ...
    @RequestBody CySysBlockSucu05button0010008 cySysBlockSucu05button0010008) {
        ...
        cySysBlockSucu05button0010008Biz.updateDataSettings(baseUserList.get(0),cySysBlockSucu05button0010008);
        if(tokenRefreshFlag) {
        	param.put("access_token", token);
        	param.put("refresh_token", refreshtoken);
    ...
    @PathVariable String id) {
        ...
        CySysBlockSucu05button0010008 cySysBlockSucu05button0010008 = cySysBlockSucu05button0010008Biz.getDataSettings(id);
        if(tokenRefreshFlag) {
        	param.put("access_token", token);
        	param.put("refresh_token", refreshtoken);
        	 
		}
        return ResultGenerator.genSuccessResult(cySysBlockSucu05button0010008,param);
    ...
    @RequestBody CySysBlockSucu05button0010008 cySysBlockSucu05button0010008) {
        ...
        List<CySysBlockSucu05button0010008> cySysBlockSucu05button0010008lst = cySysBlockSucu05button0010008Biz.getDataSettingsByCondition(cySysBlockSucu05button0010008);
        if(tokenRefreshFlag) {
        	param.put("access_token", token);
        	param.put("refresh_token", refreshtoken);
        	 
		}
        return ResultGenerator.genSuccessResult(cySysBlockSucu05button0010008lst,param);
    ...
    @RequestParam(defaultValue = "0") Integer page, @RequestParam(defaultValue = "0") Integer size) {
        ...
        try{
         PageInfo pageInfo=cySysBlockSucu05button0010008Biz.getPageDataSettings(page,size);
        if(tokenRefreshFlag) {
        	param.put("access_token", token);
        	param.put("refresh_token", refreshtoken);
    ...
    @RequestParam(defaultValue = "0") Integer page, @RequestParam(defaultValue = "0") Integer size,@RequestBody CySysBlockSucu05button0010008 cySysBlockSucu05button0010008) {
        ...
        try{
         PageInfo pageInfo=cySysBlockSucu05button0010008Biz.getPageDataSettingsByCondition(page,size,baseUserList.get(0),cySysBlockSucu05button0010008);
        if(tokenRefreshFlag) {
        	param.put("access_token", token);
        	param.put("refresh_token", refreshtoken);
