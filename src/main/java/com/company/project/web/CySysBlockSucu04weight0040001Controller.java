...
*/
@RestController
@RequestMapping("/cysysblocksucu04weight0040001")
public class CySysBlockSucu04weight0040001Controller {
	private final Log logger = LogFactory.getLog(getClass());
	
    @Resource
    private CySysBlockSucu04weight0040001Biz cySysBlockSucu04weight0040001Biz;
    ...
    @RequestBody CySysBlockSucu04weight0040001 cySysBlockSucu04weight0040001) {
        ...
        String insertId=cySysBlockSucu04weight0040001Biz.insertDataSettings(baseUserList.get(0),cySysBlockSucu04weight0040001);
    ...
    @PathVariable String ids) {
        ...
        cySysBlockSucu04weight0040001Biz.deleteDataSettings(ids);
        if(tokenRefreshFlag) {
        	param.put("access_token", token);
        	param.put("refresh_token", refreshtoken);
    ...
    @RequestBody CySysBlockSucu04weight0040001 cySysBlockSucu04weight0040001) {
        ...
        cySysBlockSucu04weight0040001Biz.updateDataSettings(baseUserList.get(0),cySysBlockSucu04weight0040001);
        if(tokenRefreshFlag) {
        	param.put("access_token", token);
        	param.put("refresh_token", refreshtoken);
    ...
    @PathVariable String id) {
        ...
        CySysBlockSucu04weight0040001 cySysBlockSucu04weight0040001 = cySysBlockSucu04weight0040001Biz.getDataSettings(id);
        if(tokenRefreshFlag) {
        	param.put("access_token", token);
        	param.put("refresh_token", refreshtoken);
        	 
		}
        return ResultGenerator.genSuccessResult(cySysBlockSucu04weight0040001,param);
    ...
    @RequestBody CySysBlockSucu04weight0040001 cySysBlockSucu04weight0040001) {
        ...
        List<CySysBlockSucu04weight0040001> cySysBlockSucu04weight0040001lst = cySysBlockSucu04weight0040001Biz.getDataSettingsByCondition(cySysBlockSucu04weight0040001);
        if(tokenRefreshFlag) {
        	param.put("access_token", token);
        	param.put("refresh_token", refreshtoken);
        	 
		}
        return ResultGenerator.genSuccessResult(cySysBlockSucu04weight0040001lst,param);
    ...
    @RequestParam(defaultValue = "0") Integer page, @RequestParam(defaultValue = "0") Integer size) {
        ...
        try{
         PageInfo pageInfo=cySysBlockSucu04weight0040001Biz.getPageDataSettings(page,size);
        if(tokenRefreshFlag) {
        	param.put("access_token", token);
        	param.put("refresh_token", refreshtoken);
    ...
    @RequestParam(defaultValue = "0") Integer page, @RequestParam(defaultValue = "0") Integer size,@RequestBody CySysBlockSucu04weight0040001 cySysBlockSucu04weight0040001) {
        ...
        try{
         PageInfo pageInfo=cySysBlockSucu04weight0040001Biz.getPageDataSettingsByCondition(page,size,baseUserList.get(0),cySysBlockSucu04weight0040001);
        if(tokenRefreshFlag) {
        	param.put("access_token", token);
        	param.put("refresh_token", refreshtoken);
