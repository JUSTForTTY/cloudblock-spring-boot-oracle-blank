...
*/
@RestController
@RequestMapping("/cysysblocksucu05button0010007")
public class CySysBlockSucu05button0010007Controller {
	private final Log logger = LogFactory.getLog(getClass());
	
    @Resource
    private CySysBlockSucu05button0010007Biz cySysBlockSucu05button0010007Biz;
    ...
    @RequestBody CySysBlockSucu05button0010007 cySysBlockSucu05button0010007) {
        ...
        String insertId=cySysBlockSucu05button0010007Biz.insertDataSettings(baseUserList.get(0),cySysBlockSucu05button0010007);
    ...
    @PathVariable String ids) {
        ...
        cySysBlockSucu05button0010007Biz.deleteDataSettings(ids);
        if(tokenRefreshFlag) {
        	param.put("access_token", token);
        	param.put("refresh_token", refreshtoken);
    ...
    @RequestBody CySysBlockSucu05button0010007 cySysBlockSucu05button0010007) {
        ...
        cySysBlockSucu05button0010007Biz.updateDataSettings(baseUserList.get(0),cySysBlockSucu05button0010007);
        if(tokenRefreshFlag) {
        	param.put("access_token", token);
        	param.put("refresh_token", refreshtoken);
    ...
    @PathVariable String id) {
        ...
        CySysBlockSucu05button0010007 cySysBlockSucu05button0010007 = cySysBlockSucu05button0010007Biz.getDataSettings(id);
        if(tokenRefreshFlag) {
        	param.put("access_token", token);
        	param.put("refresh_token", refreshtoken);
        	 
		}
        return ResultGenerator.genSuccessResult(cySysBlockSucu05button0010007,param);
    ...
    @RequestBody CySysBlockSucu05button0010007 cySysBlockSucu05button0010007) {
        ...
        List<CySysBlockSucu05button0010007> cySysBlockSucu05button0010007lst = cySysBlockSucu05button0010007Biz.getDataSettingsByCondition(cySysBlockSucu05button0010007);
        if(tokenRefreshFlag) {
        	param.put("access_token", token);
        	param.put("refresh_token", refreshtoken);
        	 
		}
        return ResultGenerator.genSuccessResult(cySysBlockSucu05button0010007lst,param);
    ...
    @RequestParam(defaultValue = "0") Integer page, @RequestParam(defaultValue = "0") Integer size) {
        ...
        try{
         PageInfo pageInfo=cySysBlockSucu05button0010007Biz.getPageDataSettings(page,size);
        if(tokenRefreshFlag) {
        	param.put("access_token", token);
        	param.put("refresh_token", refreshtoken);
    ...
    @RequestParam(defaultValue = "0") Integer page, @RequestParam(defaultValue = "0") Integer size,@RequestBody CySysBlockSucu05button0010007 cySysBlockSucu05button0010007) {
        ...
        try{
         PageInfo pageInfo=cySysBlockSucu05button0010007Biz.getPageDataSettingsByCondition(page,size,baseUserList.get(0),cySysBlockSucu05button0010007);
        if(tokenRefreshFlag) {
        	param.put("access_token", token);
        	param.put("refresh_token", refreshtoken);
