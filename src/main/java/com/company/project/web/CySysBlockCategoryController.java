...
*/
@RestController
@RequestMapping("/cysysblockcategory")
public class CySysBlockCategoryController {
	private final Log logger = LogFactory.getLog(getClass());
	
    @Resource
    private CySysBlockCategoryBiz cySysBlockCategoryBiz;
    ...
    @RequestBody CySysBlockCategory cySysBlockCategory) {
        ...
        String insertId=cySysBlockCategoryBiz.insertDataSettings(baseUserList.get(0),cySysBlockCategory);
    ...
    @PathVariable String ids) {
        ...
        cySysBlockCategoryBiz.deleteDataSettings(ids);
        if(tokenRefreshFlag) {
        	param.put("access_token", token);
        	param.put("refresh_token", refreshtoken);
    ...
    @RequestBody CySysBlockCategory cySysBlockCategory) {
        ...
        cySysBlockCategoryBiz.updateDataSettings(baseUserList.get(0),cySysBlockCategory);
        if(tokenRefreshFlag) {
        	param.put("access_token", token);
        	param.put("refresh_token", refreshtoken);
    ...
    @PathVariable String id) {
        ...
        CySysBlockCategory cySysBlockCategory = cySysBlockCategoryBiz.getDataSettings(id);
        if(tokenRefreshFlag) {
        	param.put("access_token", token);
        	param.put("refresh_token", refreshtoken);
        	 
		}
        return ResultGenerator.genSuccessResult(cySysBlockCategory,param);
    ...
    @RequestBody CySysBlockCategory cySysBlockCategory) {
        ...
        List<CySysBlockCategory> cySysBlockCategorylst = cySysBlockCategoryBiz.getDataSettingsByCondition(cySysBlockCategory);
        if(tokenRefreshFlag) {
        	param.put("access_token", token);
        	param.put("refresh_token", refreshtoken);
        	 
		}
        return ResultGenerator.genSuccessResult(cySysBlockCategorylst,param);
    ...
    @RequestParam(defaultValue = "0") Integer page, @RequestParam(defaultValue = "0") Integer size) {
        ...
        try{
         PageInfo pageInfo=cySysBlockCategoryBiz.getPageDataSettings(page,size);
        if(tokenRefreshFlag) {
        	param.put("access_token", token);
        	param.put("refresh_token", refreshtoken);
    ...
    @RequestParam(defaultValue = "0") Integer page, @RequestParam(defaultValue = "0") Integer size,@RequestBody CySysBlockCategory cySysBlockCategory) {
        ...
        try{
         PageInfo pageInfo=cySysBlockCategoryBiz.getPageDataSettingsByCondition(page,size,baseUserList.get(0),cySysBlockCategory);
        if(tokenRefreshFlag) {
        	param.put("access_token", token);
        	param.put("refresh_token", refreshtoken);
