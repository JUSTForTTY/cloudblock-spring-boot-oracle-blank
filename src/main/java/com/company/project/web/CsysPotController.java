...
*/
@RestController
@RequestMapping("/csyspot")
public class CsysPotController {
    ...
    @RequestBody CsysPot csysPot) {
        ...
        String insertId=csysPotBiz.insertDataSettings(baseUserList.get(0),csysPot);
    ...
    @PathVariable String ids) {
        ...
        csysPotBiz.deleteDataSettings(ids);
        if(tokenRefreshFlag) {
        	param.put("access_token", token);
        	param.put("refresh_token", refreshtoken);
    ...
    @RequestBody CsysPot csysPot) {
        ...
        csysPotBiz.updateDataSettings(baseUserList.get(0),csysPot);
        if(tokenRefreshFlag) {
        	param.put("access_token", token);
        	param.put("refresh_token", refreshtoken);
    ...
    @PathVariable String id) {
        ...
        CsysPot csysPot = csysPotBiz.getDataSettings(id);
        if(tokenRefreshFlag) {
        	param.put("access_token", token);
        	param.put("refresh_token", refreshtoken);
        	 
		}
        return ResultGenerator.genSuccessResult(csysPot,param);
    ...
    @RequestBody CsysPot csysPot) {
        ...
        List<CsysPot> csysPotlst = csysPotBiz.getDataSettingsByCondition(csysPot);
        if(tokenRefreshFlag) {
        	param.put("access_token", token);
        	param.put("refresh_token", refreshtoken);
        	 
		}
        return ResultGenerator.genSuccessResult(csysPotlst,param);
    ...
    @RequestParam(defaultValue = "0") Integer page, @RequestParam(defaultValue = "0") Integer size) {
        ...
        try{
         PageInfo pageInfo=csysPotBiz.getPageDataSettings(page,size);
        if(tokenRefreshFlag) {
        	param.put("access_token", token);
        	param.put("refresh_token", refreshtoken);
    ...
    @RequestParam(defaultValue = "0") Integer page, @RequestParam(defaultValue = "0") Integer size,@RequestBody CsysPot csysPot) {
        ...
        try{
         PageInfo pageInfo=csysPotBiz.getPageDataSettingsByCondition(page,size,baseUserList.get(0),csysPot);
        if(tokenRefreshFlag) {
        	param.put("access_token", token);
        	param.put("refresh_token", refreshtoken);
