...
/**
* Created by tty on 2019/07/16.
*/
@RestController
@RequestMapping("/csyspotstyle")
public class CsysPotStyleController {
	private final Log logger = LogFactory.getLog(getClass());
	
    @Resource
    private CsysPotStyleBiz csysPotStyleBiz;
    ...
    @RequestBody CsysPotStyle csysPotStyle) {
        ...
        String insertId=csysPotStyleBiz.insertDataSettings(baseUserList.get(0),csysPotStyle);
    ...
    @PathVariable String ids) {
        ...
        csysPotStyleBiz.deleteDataSettings(ids);
        if(tokenRefreshFlag) {
        	param.put("access_token", token);
        	param.put("refresh_token", refreshtoken);
    ...
    @RequestBody CsysPotStyle csysPotStyle) {
        ...
        csysPotStyleBiz.updateDataSettings(baseUserList.get(0),csysPotStyle);
        if(tokenRefreshFlag) {
        	param.put("access_token", token);
        	param.put("refresh_token", refreshtoken);
    ...
    @PathVariable String id) {
        ...
        CsysPotStyle csysPotStyle = csysPotStyleBiz.getDataSettings(id);
        if(tokenRefreshFlag) {
        	param.put("access_token", token);
        	param.put("refresh_token", refreshtoken);
        	 
		}
        return ResultGenerator.genSuccessResult(csysPotStyle,param);
    ...
    @RequestBody CsysPotStyle csysPotStyle) {
        ...
        List<CsysPotStyle> csysPotStylelst = csysPotStyleBiz.getDataSettingsByCondition(csysPotStyle);
        if(tokenRefreshFlag) {
        	param.put("access_token", token);
        	param.put("refresh_token", refreshtoken);
        	 
		}
        return ResultGenerator.genSuccessResult(csysPotStylelst,param);
    ...
    @RequestParam(defaultValue = "0") Integer page, @RequestParam(defaultValue = "0") Integer size) {
        ...
        try{
         PageInfo pageInfo=csysPotStyleBiz.getPageDataSettings(page,size);
        if(tokenRefreshFlag) {
        	param.put("access_token", token);
        	param.put("refresh_token", refreshtoken);
    ...
    @RequestParam(defaultValue = "0") Integer page, @RequestParam(defaultValue = "0") Integer size,@RequestBody CsysPotStyle csysPotStyle) {
        ...
        try{
         PageInfo pageInfo=csysPotStyleBiz.getPageDataSettingsByCondition(page,size,baseUserList.get(0),csysPotStyle);
        if(tokenRefreshFlag) {
        	param.put("access_token", token);
        	param.put("refresh_token", refreshtoken);
    ...
    @PostMapping("/listSearchCondition")
    public Result listSearchCondition(@RequestHeader(value = "access_token") String access_token,@RequestHeader(value = "refresh_token") String refresh_token,
    @RequestParam(defaultValue = "0") Integer page, @RequestParam(defaultValue = "0") Integer size,@RequestBody CsysPotStyle csysPotStyle) {
        ...
        try{
         PageInfo pageInfo=csysPotStyleBiz.getSearchPageDataSettingsByCondition(page,size,baseUserList.get(0),csysPotStyle);
        if(tokenRefreshFlag) {
        	param.put("access_token", token);
        	param.put("refresh_token", refreshtoken);
