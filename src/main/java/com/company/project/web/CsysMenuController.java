...
*/
@RestController
@RequestMapping("/csysmenu")
public class CsysMenuController {
	private final Log logger = LogFactory.getLog(getClass());
	
    @Resource
    private CsysMenuBiz csysMenuBiz;
    ...
    @RequestBody CsysMenu csysMenu) {
        ...
        String insertId=csysMenuBiz.insertDataSettings(baseUserList.get(0),csysMenu);
    ...
    @PathVariable String ids) {
        ...
        csysMenuBiz.deleteDataSettings(ids);
        if(tokenRefreshFlag) {
        	param.put("access_token", token);
        	param.put("refresh_token", refreshtoken);
    ...
    @RequestBody CsysMenu csysMenu) {
        ...
        csysMenuBiz.updateDataSettings(baseUserList.get(0),csysMenu);
        if(tokenRefreshFlag) {
        	param.put("access_token", token);
        	param.put("refresh_token", refreshtoken);
    ...
    @PathVariable String id) {
        ...
        CsysMenu csysMenu = csysMenuBiz.getDataSettings(id);
        if(tokenRefreshFlag) {
        	param.put("access_token", token);
        	param.put("refresh_token", refreshtoken);
        	 
		}
        return ResultGenerator.genSuccessResult(csysMenu,param);
    ...
    @RequestBody CsysMenu csysMenu) {
        ...
        List<CsysMenu> csysMenulst = csysMenuBiz.getDataSettingsByCondition(csysMenu);
        if(tokenRefreshFlag) {
        	param.put("access_token", token);
        	param.put("refresh_token", refreshtoken);
        	 
		}
        return ResultGenerator.genSuccessResult(csysMenulst,param);
    ...
    @RequestParam(defaultValue = "0") Integer page, @RequestParam(defaultValue = "0") Integer size) {
        ...
        try{
         PageInfo pageInfo=csysMenuBiz.getPageDataSettings(page,size);
        if(tokenRefreshFlag) {
        	param.put("access_token", token);
        	param.put("refresh_token", refreshtoken);
    ...
    @RequestParam(defaultValue = "0") Integer page, @RequestParam(defaultValue = "0") Integer size,@RequestBody CsysMenu csysMenu) {
        ...
        try{
         PageInfo pageInfo=csysMenuBiz.getPageDataSettingsByCondition(page,size,baseUserList.get(0),csysMenu);
        if(tokenRefreshFlag) {
        	param.put("access_token", token);
        	param.put("refresh_token", refreshtoken);
    ...
    @PostMapping("/tree")
    public Result treeList(@RequestHeader(value = "access_token") String access_token,@RequestHeader(value = "refresh_token") String refresh_token,
    @RequestBody CsysMenu csysMenu) {
        ...
        List<CsysMenu> csysMenulst = csysMenuBiz.getDataSettingsTree(csysMenu);
        if(tokenRefreshFlag) {
        	param.put("access_token", token);
        	param.put("refresh_token", refreshtoken);
