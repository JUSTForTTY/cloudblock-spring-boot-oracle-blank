...
*/
@RestController
@RequestMapping("/csysuserview")
public class CsysUserViewController {
	private final Log logger = LogFactory.getLog(getClass());
	
    @Resource
    private CsysUserViewBiz csysUserViewBiz;
    ...
    @RequestBody CsysUserView csysUserView) {
        ...
        String insertId=csysUserViewBiz.insertDataSettings(baseUserList.get(0),csysUserView);
    ...
    @RequestBody CsysUserView csysUserView) {
        ...
        List<CsysUserView> csysUserViewlst = csysUserViewBiz.getDataSettingsByCondition(csysUserView);
        if(tokenRefreshFlag) {
        	param.put("access_token", token);
        	param.put("refresh_token", refreshtoken);
    ...
    @RequestParam(defaultValue = "0") Integer page, @RequestParam(defaultValue = "0") Integer size,@RequestBody CsysUserView csysUserView) {
        ...
        try{
         PageInfo pageInfo=csysUserViewBiz.getPageDataSettingsByCondition(page,size,baseUserList.get(0),csysUserView);
        if(tokenRefreshFlag) {
        	param.put("access_token", token);
        	param.put("refresh_token", refreshtoken);
