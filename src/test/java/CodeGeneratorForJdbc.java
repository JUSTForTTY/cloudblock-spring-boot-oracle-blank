 ...
 */
public class CodeGeneratorForJdbc {
    //JDBC配置，请修改为你项目的实际配置
    private static final String JDBC_URL = "jdbc:mysql://rm-bp12q53hd45s689okco.mysql.rds.aliyuncs.com:3306/cloudblock_tools_v1";
    private static final String JDBC_URL_OUTER = "jdbc:mysql://rm-bp12q53hd45s689okco.mysql.rds.aliyuncs.com:3306/cloudblock_v1";
    private static final String JDBC_USERNAME = "root";
    private static final String JDBC_PASSWORD = "!QAZ2wsxchuangyou";
    ...
    public static void main(String[] args) {
    	genOuterCode("cy_sys_menu_page_view");
    	//genCode("cy_sys_organizational_structure_point_authority"); 
    ...
    public static void genOuterModelAndMapper(String tableName, String modelName) {
        ...
        JDBCConnectionConfiguration jdbcConnectionConfiguration = new JDBCConnectionConfiguration();
        jdbcConnectionConfiguration.setConnectionURL(JDBC_URL_OUTER);
        jdbcConnectionConfiguration.setUserId(JDBC_USERNAME);
        jdbcConnectionConfiguration.setPassword(JDBC_PASSWORD);
        jdbcConnectionConfiguration.setDriverClass(JDBC_DIVER_CLASS_NAME);
        context.setJdbcConnectionConfiguration(jdbcConnectionConfiguration);
