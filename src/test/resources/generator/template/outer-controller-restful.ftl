...
public class ${modelNameUpperCamel}Controller {
    ...
    @RequestBody ${modelNameUpperCamel} ${modelNameLowerCamel}) {
        ...
        String insertId=${modelNameLowerCamel}Biz.insertDataSettings(baseUserList.get(0),${modelNameLowerCamel});
    ...
    @PathVariable String ids) {
        ...
        ${modelNameLowerCamel}Biz.deleteDataSettings(ids);
        if(tokenRefreshFlag) {
        	param.put("access_token", token);
        	param.put("refresh_token", refreshtoken);
    ...
    @RequestBody ${modelNameUpperCamel} ${modelNameLowerCamel}) {
        ...
        ${modelNameLowerCamel}Biz.updateDataSettings(baseUserList.get(0),${modelNameLowerCamel});
        if(tokenRefreshFlag) {
        	param.put("access_token", token);
        	param.put("refresh_token", refreshtoken);
    ...
    @PathVariable String id) {
        ...
        ${modelNameUpperCamel} ${modelNameLowerCamel} = ${modelNameLowerCamel}Biz.getDataSettings(id);
        if(tokenRefreshFlag) {
        	param.put("access_token", token);
        	param.put("refresh_token", refreshtoken);
        	 
		}
        return ResultGenerator.genSuccessResult(${modelNameLowerCamel},param);
    ...
    @RequestBody ${modelNameUpperCamel} ${modelNameLowerCamel}) {
        ...
        List<${modelNameUpperCamel}> ${modelNameLowerCamel}lst = ${modelNameLowerCamel}Biz.getDataSettingsByCondition(${modelNameLowerCamel});
        if(tokenRefreshFlag) {
        	param.put("access_token", token);
        	param.put("refresh_token", refreshtoken);
        	 
		}
        return ResultGenerator.genSuccessResult(${modelNameLowerCamel}lst,param);
    ...
    @RequestParam(defaultValue = "0") Integer page, @RequestParam(defaultValue = "0") Integer size) {
        ...
        try{
         PageInfo pageInfo=${modelNameLowerCamel}Biz.getPageDataSettings(page,size);
        if(tokenRefreshFlag) {
        	param.put("access_token", token);
        	param.put("refresh_token", refreshtoken);
    ...
    @RequestParam(defaultValue = "0") Integer page, @RequestParam(defaultValue = "0") Integer size,@RequestBody ${modelNameUpperCamel} ${modelNameLowerCamel}) {
        ...
        try{
         PageInfo pageInfo=${modelNameLowerCamel}Biz.getPageDataSettingsByCondition(page,size,baseUserList.get(0),${modelNameLowerCamel});
        if(tokenRefreshFlag) {
        	param.put("access_token", token);
        	param.put("refresh_token", refreshtoken);
